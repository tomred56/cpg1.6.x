...
$name = $lang_plugin_dedits['config_name'];
$description = $lang_plugin_dedits['config_description'];
...
$extra_info = <<<EOT
    ...
    <tr>
        <td><a href="docs/en/plugins.htm" title="{$lang_plugin_dedits['plugin_documentation']}" class="admin_menu">{$lang_plugin_dedits['plugin_documentation']}</a></td>
    </tr>
    </table>
EOT;
/*
...
$install_info = <<<EOT
    <table border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td><a href="http://coppermine-gallery.net/forum/index.php?board=97.0" title="{$lang_plugin_dedits['plugin_support']}" class="admin_menu">{$lang_plugin_dedits['plugin_support']}</a></td>
    </tr>
    </table>
EOT;
/*
