...
function theme_html_picture()
{
    ...
    $params = array('{CELL_HEIGHT}' => '100',
        ...
        '{DETAIL1}' => bb_decode($CURRENT_PIC_DATA['user1']),
        '{DETAIL2}' => bb_decode($CURRENT_PIC_DATA['user2']),
        '{DETAIL3}' => bb_decode($CURRENT_PIC_DATA['user3']),
        '{DETAIL4}' => bb_decode($CURRENT_PIC_DATA['user4']),
        );
