...
/*************************
  ...
  ********************************************
  ...
  $HeadURL: https://svn.code.sf.net/p/coppermine/code/trunk/cpg1.5.x/lang/luxembourgish.php $
  $Revision: 8873 $
**********************************************/
...
$lang_translation_info['lang_name_english'] = 'Luxembourgish';
$lang_translation_info['lang_name_native'] = 'Lëtzebuergesch';
$lang_translation_info['lang_country_code'] = 'lu';
$lang_translation_info['trans_name'] = 'Francis Manderscheid (wuschel_lux)';
$lang_translation_info['trans_email'] = '';
$lang_translation_info['trans_website'] = 'http://www.volleyball.lu/';
$lang_translation_info['trans_date'] = '2010-03-09';
...
$lang_day_of_week = array('Sonndes', 'Méindes', 'Dënschdeg', 'Mëttwoch', 'Donneschdeg', 'Freideg', 'Samschdeg');
$lang_month = array('Januar', 'Februar', 'Mäerz', 'Abrëll', 'Mee', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember');
...
$lang_meta_album_names['random'] = 'Zoufälleg Datei';
$lang_meta_album_names['lastup'] = 'Lëscht eropgelueden Dateien';
$lang_meta_album_names['lastalb'] = 'Lëscht aktualiséiert Albumen';
$lang_meta_album_names['lastcom'] = 'Lëschten Commentaire';
$lang_meta_album_names['topn'] = 'Am meeschten gekuckt';
$lang_meta_album_names['toprated'] = 'Am beschten bewäert';
$lang_meta_album_names['lasthits'] = 'Fir d\'läscht gekuckt';
$lang_meta_album_names['search'] = 'D\'Resultat vun ärer Foto Recherche';
$lang_meta_album_names['album_search'] = 'D\'Resultat vun ärer Album Recherche';
$lang_meta_album_names['category_search'] = 'D\'Resultat vun ärer Kategorie Recherche';
$lang_meta_album_names['favpics'] = 'Favoriten Dateien';
$lang_meta_album_names['datebrowse'] = 'No Datum sichen'; //cpg1.5

$lang_errors['access_denied'] = 'Dir hutt keng Erlaabnis op dës Säit zougräifen.';
$lang_errors['invalid_form_token'] = 'A valid form token could not be found.'; //cpg1.5
$lang_errors['perm_denied'] = 'Dir hutt keng Erlaabnis dës Operatioun duerchzeféieren.';
$lang_errors['param_missing'] = 'Dësen Skript ass ouni déi benéidegt Parameteren opgeruff ginn.';
$lang_errors['non_exist_ap'] = 'Den gewënschten Album oder Datei existéiert net!';
$lang_errors['quota_exceeded'] = 'Späicherplaatz ass opgebraucht.'; //cpg1.5
$lang_errors['quota_exceeded_details'] = 'Dir hutt eng Späicherplaatz vun [quota], är Dateien beleeën am Moment [space], d\'eropluede vun weidere Dateien géif d\'Limite vun ärer Späicherplaatz iwwerschreiden.'; //cpg1.5
$lang_errors['gd_file_type_err'] = 'Wann dir d\'GD Librairie benotzt, sinn just JPEG an PNG Dateitypen erlaabt.';
$lang_errors['invalid_image'] = 'Dat Bild wat dir grad eropgelueden hutt, ass korrupt an kann net mat der GD Librairie verschafft ginn';
$lang_errors['resize_failed'] = 'Et ass onméiglech en Thumbnail oder en verklengert Bild ze erstellen.';
$lang_errors['no_img_to_display'] = 'Et ass keen Bild do fir ugewisen ze ginn';
$lang_errors['non_exist_cat'] = 'Déi gewielten Kategorie existéiert net';
$lang_errors['directory_ro'] = 'D\'Verzeechniss \'%s\' ass net schreiwbar, Dateien kënnen net geläscht ginn';
$lang_errors['pic_in_invalid_album'] = 'Datei ass an engem Album deen net existéiert (%s)!?';
$lang_errors['banned'] = 'Dir sidd aktuell op dësem Site gespaart.';
$lang_errors['offline_title'] = 'Offline';
$lang_errors['offline_text'] = 'D\'Galerie ass am Moment net erreechbar - kommt w.e.g. spéider erëm';
$lang_errors['ecards_empty'] = 'Am Moment sinn keng E-Cards Opzeechnungen do fir unzeweisen.';
$lang_errors['database_query'] = 'Et gouf en Problem bei enger Datebank Offroe';
$lang_errors['non_exist_comment'] = 'Den gewieltenen Kommentare existéiert net';
$lang_errors['captcha_error'] = 'Den Konfirmatioun Code stëmmt net iwwerteneen'; // cpg1.5
$lang_errors['login_needed'] = 'Dir musst iech %sregistréieren%s/%saloggen%s fir dës Säiten ze gesinn'; // cpg1.5
$lang_errors['error'] = 'Fehler'; // cpg1.5
$lang_errors['critical_error'] = 'Kriteschen Fehler'; // cpg1.5
$lang_errors['access_thumbnail_only'] = 'Dir däerf just Thubnails kucken.'; // cpg1.5
$lang_errors['access_intermediate_only'] = 'Dir hutt keng Erlaabnis fir Biller an voller Opléisung ze kucken.'; // cpg1.5
$lang_errors['access_none'] = 'Dir hutt keng Erlaabnis fir d\'Biller ze kucken.'; // cpg1.5
...
$lang_bbcode_help_title = 'BBCode Hëllef';
...
$lang_common['yes'] = 'Jo'; // cpg1.5
$lang_common['no'] = 'Nee'; // cpg1.5
$lang_common['back'] = 'Zeréck'; // cpg1.5
$lang_common['continue'] = 'Weider'; // cpg1.5
$lang_common['information'] = 'Informatiounen'; // cpg1.5
$lang_common['error'] = 'Fehler'; // cpg1.5
$lang_common['check_uncheck_all'] = 'check/uncheck all'; // cpg1.5
$lang_common['confirm'] = 'Confirmatioun'; // cpg1.5
$lang_common['captcha_help_title'] = 'Visuell Confirmatioun (captcha)'; // cpg1.5
$lang_common['captcha_help'] = 'Fir Spam ze vermeiden, muss dir confirméieren, dass dir en Mënsch sidd an net en Roboter oder Skript, andeems dir deen ugewisen Textantippt. < br /> Grouss- Kleng schreiwen ass net wichteg, dir kennt einfach alles an Klengbuschtawen aginn.'; // cpg1.5
$lang_common['title'] = 'Titel'; // cpg1.5
$lang_common['caption'] = 'Caption'; // cpg1.5
$lang_common['keywords'] = 'Keywords'; // cpg1.5
$lang_common['keywords_insert1'] = 'Keywords (getrennt matt %s)'; // cpg1.5
$lang_common['keywords_insert2'] = 'Aus der Lëscht ausfëllen'; // cpg1.5
$lang_common['keyword_separator'] = 'Keyword Trenn-zeechen'; //cpg1.5
$lang_common['keyword_separators'] = array(' '=>'Espace', ','=>'Komma', ';'=>'Semicolon'); // cpg1.5
$lang_common['owner_name'] = 'Owner name'; // cpg1.5
$lang_common['filename'] = 'Dateinumm'; // cpg1.5
$lang_common['filesize'] = 'Gréisst vun der Datei'; // cpg1.5
$lang_common['album'] = 'Album'; // cpg1.5
$lang_common['file'] = 'Datei'; // cpg1.5
$lang_common['date'] = 'Datum'; // cpg1.5
$lang_common['help'] = 'Hëllef'; // cpg1.5
$lang_common['close'] = 'Zoumaachen'; // cpg1.5
$lang_common['go'] = 'go'; // cpg1.5
$lang_common['javascript_needed'] = 'Dës Säit brauch JavaScript. Aktivéiert w.e.g. den JavaScript an ärem Browser.'; // cpg1.5
$lang_common['move_up'] = 'Erop beweegen'; // cpg1.5
$lang_common['move_down'] = 'Erof beweegen'; // cpg1.5
$lang_common['move_top'] = 'Un den Ufank beweegen'; // cpg1.5
$lang_common['move_bottom'] = 'Un den Schluss beweegen'; // cpg1.5
$lang_common['delete'] = 'Läschen'; // cpg1.5
$lang_common['edit'] = 'Änneren'; // cpg1.5
$lang_common['username_if_blank'] = 'Unknown coward'; // cpg1.5
$lang_common['albums_no_category'] = 'Album ouni Kategorie'; // cpg1.5
$lang_common['personal_albums'] = '* Perséinlech Albumen'; // cpg1.5
$lang_common['select_album'] = 'Wielt en Album aus'; // cpg1.5
$lang_common['ok'] = 'OK'; // cpg1.5
$lang_common['status'] = 'Status'; // cpg1.5
$lang_common['apply_changes'] = 'Ännerungen ausféieren'; // cpg1.5
$lang_common['done'] = 'Fäerdeg'; // cpg1.5
$lang_common['album_properties'] = 'Album Eegenschaften'; // cpg1.5
$lang_common['parent_category'] = 'Haaptkategorie'; // cpg1.5
$lang_common['edit_files'] = 'Dateien änneren'; // cpg1.5
$lang_common['thumbnail_view'] = 'Thumbnail Usiicht'; // cpg1.5
$lang_common['album_manager'] = 'Album Manager'; // cpg1.5
$lang_common['more'] = 'méi'; // cpg1.5

// ------------------------------------------------------------------------- //
// File theme.php
// ------------------------------------------------------------------------- //

$lang_main_menu['home_title'] = 'Zeréck op d\'Startsäit';
$lang_main_menu['home_lnk'] = 'Startsäit';
$lang_main_menu['alb_list_title'] = 'Géi an d\'Album Lëscht';
$lang_main_menu['alb_list_lnk'] = 'Album Lëscht';
$lang_main_menu['my_gal_title'] = 'Géi an meng perséinlech Galerie';
$lang_main_menu['my_gal_lnk'] = 'Meng Galerie';
$lang_main_menu['my_prof_title'] = 'Géi an mäin Profil';
$lang_main_menu['my_prof_lnk'] = 'Mäin Profil';
$lang_main_menu['adm_mode_title'] = 'Aktivéier d\'Administrator Menüen'; // cpg1.5
$lang_main_menu['adm_mode_lnk'] = 'Weis d\'Administrator Menüen'; // cpg1.5
$lang_main_menu['usr_mode_title'] = 'Desaktivéier d\'Administrator Menüen'; // cpg1.5
$lang_main_menu['usr_mode_lnk'] = 'Verstopp d\'Administrator Menüen'; // cpg1.5
$lang_main_menu['upload_pic_title'] = 'Lued eng Datei an en Album';
$lang_main_menu['upload_pic_lnk'] = 'Datei eroplueden';
$lang_main_menu['register_title'] = 'En Account erstellen';
$lang_main_menu['register_lnk'] = 'Registréieren';
$lang_main_menu['login_title'] = 'Aloggen';
$lang_main_menu['login_lnk'] = 'Aloggen';
$lang_main_menu['logout_title'] = 'Ausloggen';
$lang_main_menu['logout_lnk'] = 'Ausloggen';
$lang_main_menu['lastup_title'] = 'Weis mir déi leschten Uploads';
$lang_main_menu['lastup_lnk'] = 'Leschten Uploads';
$lang_main_menu['lastcom_title'] = 'Weis mir déi leschten Kommentaren';
$lang_main_menu['lastcom_lnk'] = 'Leschten Kommentaren';
$lang_main_menu['topn_title'] = 'Weis mir déi am meeschten gekuckten Dateien';
$lang_main_menu['topn_lnk'] = 'Meescht gekuckten Dateien';
$lang_main_menu['toprated_title'] = 'Weis mir déi am beschten bewäerten Dateien';
$lang_main_menu['toprated_lnk'] = 'Beschten bewäerten Dateien';
$lang_main_menu['search_title'] = 'An der Galerie sichen';
$lang_main_menu['search_lnk'] = 'Sichen';
$lang_main_menu['fav_title'] = 'Weis meng Favoriten';
$lang_main_menu['fav_lnk'] = 'Meng Favoriten';
$lang_main_menu['memberlist_title'] = 'Weis d\'Memberslescht';
$lang_main_menu['memberlist_lnk'] = 'Memberslescht';
$lang_main_menu['browse_by_date_lnk'] = 'No Datum'; // cpg1.5
$lang_main_menu['browse_by_date_title'] = 'Sichen nom Datum wou Datei eropgelueden gouf'; // cpg1.5
$lang_main_menu['contact_title'] = 'Kommt a Kontakt mat %s'; // cpg1.5
$lang_main_menu['contact_lnk'] = 'Kontakt'; // cpg1.5
$lang_main_menu['sidebar_title'] = 'Eng Sidebar am Browser derbäi setzen'; // cpg1.5
$lang_main_menu['sidebar_lnk'] = 'Sidebar'; // cpg1.5

$lang_gallery_admin_menu['upl_app_title'] = 'Nei Dateien bestätegen';
$lang_gallery_admin_menu['upl_app_lnk'] = 'Dateien bestätegen';
$lang_gallery_admin_menu['admin_title'] = 'Weis den Konfiguratioun\'s Menü';
$lang_gallery_admin_menu['admin_lnk'] = 'Konfiguratioun\'s Menü';
$lang_gallery_admin_menu['albums_title'] = 'Weis den Album Konfiguratioun\'s Menü';
$lang_gallery_admin_menu['albums_lnk'] = 'Albumen';
$lang_gallery_admin_menu['categories_title'] = 'Weis den Kategorie Konfiguratioun\'s Menü';
$lang_gallery_admin_menu['categories_lnk'] = 'Kategorien';
$lang_gallery_admin_menu['users_title'] = 'Weis den Benotzer Konfiguratioun\'s Menü';
$lang_gallery_admin_menu['users_lnk'] = 'Benotzer';
$lang_gallery_admin_menu['groups_title'] = 'Weis den Groupe Konfiguratioun\'s Menü';
$lang_gallery_admin_menu['groups_lnk'] = 'Groupen';
$lang_gallery_admin_menu['comments_title'] = 'All d\'Commentairen nokucken';
$lang_gallery_admin_menu['comments_lnk'] = 'Commentairen nokucken';
$lang_gallery_admin_menu['searchnew_title'] = 'Weis den Massen Upload vun Dateien';
$lang_gallery_admin_menu['searchnew_lnk'] = 'Massen Upload vun Dateien';
$lang_gallery_admin_menu['util_title'] = 'Weis d\'Administrator Tools';
$lang_gallery_admin_menu['util_lnk'] = 'Admin Tools';
$lang_gallery_admin_menu['key_lnk'] = 'Keyword Dictionnaire';
$lang_gallery_admin_menu['ban_title'] = 'Wei déi gespaarten Benotzer';
$lang_gallery_admin_menu['ban_lnk'] = 'Gespaarten Benotzer';
$lang_gallery_admin_menu['db_ecard_title'] = 'Ecards nokucken';
$lang_gallery_admin_menu['db_ecard_lnk'] = 'Weis Ecards';
$lang_gallery_admin_menu['pictures_title'] = 'Sortéier meng Biller';
$lang_gallery_admin_menu['pictures_lnk'] = 'Sortéier meng Biller';
$lang_gallery_admin_menu['documentation_lnk'] = 'Dokumentatioun';
$lang_gallery_admin_menu['documentation_title'] = 'Coppermine Dokumentatioun';
$lang_gallery_admin_menu['phpinfo_lnk'] = 'phpinfo'; // cpg1.5
$lang_gallery_admin_menu['phpinfo_title'] = 'Enthält technesch Informatiounen iwwert den Server. Et kann sinn dass dir dës gefrot gitt, wann dir Support ugefrot hutt.'; // cpg1.5
$lang_gallery_admin_menu['update_database_lnk'] = 'Datebank Update'; // cpg1.5
$lang_gallery_admin_menu['update_database_title'] = 'Wann dir Coppermine Dateien derbäi gesat/modifizéiert hutt oder en Upgrade gemaach hutt, musst dir den Datebank Update een mol lafen loossen. Hei duerch ginn déi noutwenneg Tabellen an/oder Konfiguratiounen Wäerter an der Datebank gemaach.'; // cpg1.5
$lang_gallery_admin_menu['view_log_files_lnk'] = 'Weis all d\'Log Dateien'; // cpg1.5
$lang_gallery_admin_menu['view_log_files_title'] = 'Coppermine kann sämtlech Aktiounen vun Useren opzeechnen. Dir kennt dës Logs duerchsichen, wann dir dëst an den Coppermine Konfiguratioun agestallt hutt.'; // cpg1.5
$lang_gallery_admin_menu['check_versions_lnk'] = 'Versions Check'; // cpg1.5
$lang_gallery_admin_menu['check_versions_title'] = 'Iwwerpréift d\'Versiounen vun ären Systemdateien an fannt raus ob no engem Upgrade all Dateien an der richteger Versioun verfügbar sinn, oder ob d\'Coppermine System Dateien Upgedate goufen. '; // cpg1.5
$lang_gallery_admin_menu['bridgemgr_lnk'] = 'Bridge Manager'; // cpg1.5
$lang_gallery_admin_menu['bridgemgr_title'] = 'Aktivéier/desaktivéier d\'Integratioun (bridging) vun Coppermine mat enger anerer Applikatioun.'; // cpg1.5
$lang_gallery_admin_menu['pluginmgr_lnk'] = 'Plugin Manager'; // cpg1.5
$lang_gallery_admin_menu['pluginmgr_title'] = 'Plugin Manager'; // cpg1.5
$lang_gallery_admin_menu['overall_stats_lnk'] = 'Statistiken'; // cpg1.5
$lang_gallery_admin_menu['overall_stats_title'] = 'Kuckt d\'komplett Hit Statistiken (wann déi néideg Astellungen an der Konfiguratioun ageschalt sinn)'; // cpg1.5
$lang_gallery_admin_menu['keywordmgr_lnk'] = 'Keyword Manager'; // cpg1.5
$lang_gallery_admin_menu['keywordmgr_title'] = 'Verwalt d\'Keywords (wann déi néideg Astellungen an der Konfiguratioun ageschalt sinn).'; // cpg1.5
$lang_gallery_admin_menu['exifmgr_lnk'] = 'EXIF Manager'; // cpg1.5
$lang_gallery_admin_menu['exifmgr_title'] = 'Verwalt d\'EXIF Daten (wann déi néideg Astellungen an der Konfiguratioun ageschalt sinn).'; // cpg1.5
$lang_gallery_admin_menu['shownews_lnk'] = 'Weis d\'Neiegkeeten'; // cpg1.5
$lang_gallery_admin_menu['shownews_title'] = 'Weis d\'Neiegkeeten vun coppermine-gallery.net'; // cpg1.5

$lang_user_admin_menu['albmgr_title'] = 'Erstell oder sortéier meng Albumen';
$lang_user_admin_menu['albmgr_lnk'] = 'Erstell / sortéier meng Albumen';
$lang_user_admin_menu['modifyalb_title'] = 'Weis den Menü änner meng Albumen';
$lang_user_admin_menu['modifyalb_lnk'] = 'Änner meng Albumen';
$lang_user_admin_menu['my_prof_title'] = 'Weis den Menü mäin perséinlechen Profil';
$lang_user_admin_menu['my_prof_lnk'] = 'Mäin Profil';

$lang_cat_list['category'] = 'Kategorien';
$lang_cat_list['albums'] = 'Albumen';
$lang_cat_list['pictures'] = 'Dateien';

$lang_album_list['album_on_page'] = '%d Albumen op %d Säit(en)';

$lang_thumb_view['date'] = 'Datum';
//Sort by filename and title
$lang_thumb_view['name'] = 'Datei Numm';
$lang_thumb_view['sort_da'] = 'Sortéier no Datum opsteigend';
$lang_thumb_view['sort_dd'] = 'Sortéier no Datum ofsteigend';
$lang_thumb_view['sort_na'] = 'Sortéier no Numm opsteigend';
$lang_thumb_view['sort_nd'] = 'Sortéier no Numm ofsteigend';
$lang_thumb_view['sort_ta'] = 'Sortéier no Titel opsteigend';
$lang_thumb_view['sort_td'] = 'Sortéier no Titel ofsteigend';
$lang_thumb_view['position'] = 'Positioun';
$lang_thumb_view['sort_pa'] = 'Sortéier no Positioun opsteigend';
$lang_thumb_view['sort_pd'] = 'Sortéier no Positioun ofsteigend';
$lang_thumb_view['download_zip'] = 'Als ZIP Datei eroflueden';
$lang_thumb_view['pic_on_page'] = '%d Dateien op %d Säit(en)';
$lang_thumb_view['user_on_page'] = '%d Benotzer op %d Säit(en)';
$lang_thumb_view['enter_alb_pass'] = 'Gitt en Album Passwuert an';
$lang_thumb_view['invalid_pass'] = 'Falscht Passwuert';
$lang_thumb_view['pass'] = 'Passwuert';
$lang_thumb_view['submit'] = 'ofschécken';
$lang_thumb_view['zipdownload_copyright'] = 'Respektéiert w.e.g. d\'Copyrights - benotzt déi Dateien déi dir erofgelueden hutt, sou wei den Autor dat virgesäit'; // cpg1.5
$lang_thumb_view['zipdownload_username'] = 'Dësen Archiv enthält déi gezippten Dateien aus ären Favoriten vun %s'; // cpg1.5

$lang_img_nav_bar['thumb_title'] = 'Zeréck op Thumbnail Säit';
$lang_img_nav_bar['pic_info_title'] = 'Weis/verstopp Datei Informatiounen';
$lang_img_nav_bar['slideshow_title'] = 'Slideshow';
$lang_img_nav_bar['ecard_title'] = 'Verschéck dës Datei als E-Kaart';
$lang_img_nav_bar['ecard_disabled'] = 'E-Kaarten sinn ausgeschalt';
$lang_img_nav_bar['ecard_disabled_msg'] = 'Dir hutt keng Erlaabnis fir E-Kaarten ze verschécken'; // js-alert
$lang_img_nav_bar['prev_title'] = 'Eng Datei weider';
$lang_img_nav_bar['next_title'] = 'Eng Datei zeréck';
$lang_img_nav_bar['pic_pos'] = 'DATEI %s/%s';
$lang_img_nav_bar['report_title'] = 'Dem Administrator dës Datei mellen';
$lang_img_nav_bar['go_album_end'] = 'Weider bis un d\'Enn';
$lang_img_nav_bar['go_album_start'] = 'Zeréck un den Ufank';

$lang_rate_pic['rate_this_pic'] = 'Bewäert dës Datei ';
$lang_rate_pic['no_votes'] = '(nach net bewäert)';
$lang_rate_pic['rating'] = '(Aktuell Bewäertung: %s / %s mat %s Stëmmen)';
$lang_rate_pic['rubbish'] = 'Schrott';
$lang_rate_pic['poor'] = 'Schlecht';
$lang_rate_pic['fair'] = 'Ganz OK';
$lang_rate_pic['good'] = 'Gutt';
$lang_rate_pic['excellent'] = 'Excellent';
$lang_rate_pic['great'] = 'Genial';
$lang_rate_pic['js_warning'] = 'Fir ofzestëmmen muss den JavaScript ageschalt sinn'; // cpg1.5
$lang_rate_pic['already_voted'] = 'Dir hutt schon fir dëst Bild ofgestëmmt.'; // cpg1.5
$lang_rate_pic['forbidden'] = 'Dir kënnt net fir är eegen Dateien ofstëmmen.'; // cpg1.5
$lang_rate_pic['rollover_to_rate'] = 'Fuert mat der Maus driwwer fir ofzestëmmen'; // cpg1.5
...
$lang_cpg_die['line'] = 'Linn: ';

$lang_display_thumbnails['dimensions'] = 'Dimensiounen=';
$lang_display_thumbnails['date_added'] = 'Datum vum Upload=';

$lang_get_pic_data['n_comments'] = '%s Kommentaren';
$lang_get_pic_data['n_views'] = '%s mol gekuckt ginn';
$lang_get_pic_data['n_votes'] = '(%s Stëmmen)';

$lang_cpg_debug_output['debug_info'] = 'Debug Info';
$lang_cpg_debug_output['debug_output'] = 'Debug Output'; // cpg1.5
$lang_cpg_debug_output['select_all'] = 'All auswielen';
$lang_cpg_debug_output['copy_and_paste_instructions'] = 'Wann dir Hëllef am Support Forum vun Coppermine sicht, maacht en Copy & Paste vun dësem Debug Message an Fehler Message (wann et een gëtt), an är Forum Ufro, wann dëst gefrot ass. Post dësen (debug_output) awer nëmmen, wann dir explizit vun engem Supporter gefrot gitt! Stellt sécher, dass dir all är Passwierder vun den Query\'en mat *** onkenntlech maacht.'; // cpg1.5
$lang_cpg_debug_output['debug_output_explain'] = 'Note: Dat hei ass eng Informatioun an heescht net, dass et en Problem mat der Galerie gëtt.'; // cpg1.5
$lang_cpg_debug_output['phpinfo'] = 'phpinfo uweisen';
$lang_cpg_debug_output['notices'] = 'Notices';
$lang_cpg_debug_output['notices_help_admin'] = 'Dës Messagen ginn hei op dëser Säit ugewisen, wëlls dir (als Admin) dësen Feature an der Coppermine Konfiguratioun ageschalt hutt. Dat wëllt net zwangsleefeg bedeiten dass et en Problem mat ärer Galerie gëtt. Heibäi handelt et sech ëm Informatiounen, déi experimentéierten Programmateuren et erlaben, Fehler ze erkennen. Wann dës Messagen iech näischt soen, schalt se an der Konfiguratioun aus.'; // cpg1.5
$lang_cpg_debug_output['notices_help_non_admin'] = 'Dës Messagen goufen vum Admin ageschalt. Dëst bedeit net dass ëmmer Schief leeft. Dir kënnt dës Messagen ignoréieren.'; // cpg1.5
$lang_cpg_debug_output['show_hide'] = 'weisen / verstoppen'; // cpg1.5

$lang_language_selection['reset_language'] = 'Standard Sprooch';
$lang_language_selection['choose_language'] = 'Wielt är Sprooch aus';

$lang_theme_selection['reset_theme'] = 'Standard Layout';
$lang_theme_selection['choose_theme'] = 'Wielt en Layout aus ';

$lang_version_alert['version_alert'] = 'Dës Versioun gëtt net ënnerstëtzt!';
$lang_version_alert['no_stable_version'] = 'Dir benotzt Coppermine &s (%s) déi just fir experimentéiert Useren ass - op dëser Versioun ass keen Support oder Garantien drop.Dir benotzt dës op eegen Gefor. Wann dir Support braucht, maacht w.e.g. en Downgrade op déi leschten stabil Versioun!';
$lang_version_alert['gallery_offline'] = 'Dës Galerie ass am Moment Offline an as nëmmen fir Administratoren siichtbar. Vergiesst net d\'Säit rëm Online ze sëtzen wann dir mat ären Maintenance Aarbechten fäerdeg sidd.';
$lang_version_alert['coppermine_news'] = 'Neiegkeeten vun coppermine-gallery.net'; // cpg1.5
$lang_version_alert['no_iframe'] = 'Ären Browser kann keng Inline Frames uweisen'; // cpg1.5
$lang_version_alert['hide'] = 'verstoppen'; // cpg1.5

$lang_create_tabs['previous'] = 'Zeréck'; // cpg1.5
$lang_create_tabs['next'] = 'Weider'; // cpg1.5
$lang_create_tabs['jump_to_page'] = 'Sprang op d\'Säit'; // cpg1.5
...
$lang_get_remote_file_by_url['error_message'] = 'Fehler Message: %s'; // cpg1.5
...
// ------------------------------------------------------------------------- //
$lang_plugin_api['error_install'] = 'Plugin konnt net installéiert ginn \'%s\'';
$lang_plugin_api['error_uninstall'] = 'Plugin konnt net desinstalléier ginn \'%s\'';
$lang_plugin_api['error_sleep'] = 'Plugin konnt net ausgeschalt ginn \'%s\''; // cpg1.5
...
$lang_albmgr_php['alb_need_name'] = 'En Album muss en Numm hunn!'; // js-alert
$lang_albmgr_php['confirm_modifs'] = 'Sidd dir sécher dës Ännerungen ze maachen?'; // js-alert
$lang_albmgr_php['no_change'] = 'Dir hutt keng Ännerungen gemaach!'; // js-alert
$lang_albmgr_php['new_album'] = 'Néien Album';
$lang_albmgr_php['delete_album'] = 'Album läschen'; // cpg1.5
$lang_albmgr_php['confirm_delete1'] = 'Sidd dir sécher fir dësen Album ze läschen?'; // js-alert
$lang_albmgr_php['confirm_delete2'] = 'All Dateien an Commentairen ginn geläscht!'; // js-alert
$lang_albmgr_php['select_first'] = 'Wielt fir d\'éischt en Album aus'; // js-alert
$lang_albmgr_php['my_gallery'] = '* Meng Galerie *';
$lang_albmgr_php['no_category'] = '* Keng Kategorie *';
$lang_albmgr_php['select_category'] = 'Wielt eng Kategorie aus';
$lang_albmgr_php['category_change'] = 'Wann dir d\'Kategorie ännert, verléiert dir all är Ännerungen!'; // cpg1.5
$lang_albmgr_php['page_change'] = 'Wann dir dësen Link verfollegt, verléiert dir all är Ännerungen!'; // cpg1.5
$lang_albmgr_php['cancel'] = 'Ofbriechen'; // cpg1.5
$lang_albmgr_php['submit_reminder'] = 'D\'Ännerungen ginn net gespäichert, bis dir &quot;Ännerungen ausféieren&quot; uklickt.'; // cpg1.5
}
...
$lang_banning_php['title'] = 'Gespaarten User';
$lang_banning_php['user_name'] = 'User Numm';
$lang_banning_php['user_account'] = 'User Account';
$lang_banning_php['email_address'] = 'E-Mail Adress'; // cpg1.5
$lang_banning_php['ip_address'] = 'IP Adress';
$lang_banning_php['expires'] = 'Expires'; // cpg1.5
$lang_banning_php['expiry_date'] = 'Expiry date'; // cpg1.5
$lang_banning_php['expired'] = 'Expired'; // cpg1.5
$lang_banning_php['edit_ban'] = 'Ännerungen späicheren';
$lang_banning_php['add_new'] = 'Néien User spären';
$lang_banning_php['add_ban'] = 'Bäisetzen';
$lang_banning_php['error_user'] = 'Kann den User net fannen';
$lang_banning_php['error_specify'] = 'Dir musst entweder User Numm oder IP Adress uginn';
$lang_banning_php['error_ban_id'] = 'Falsch Spär ID!';
$lang_banning_php['error_admin_ban'] = 'Dir kënnt iech net selwer spären!';
$lang_banning_php['error_server_ban'] = 'Dir späert grad ären eegenen Server? Keng gutt Idee, dat gëtt net...';
$lang_banning_php['skipping'] = 'Dësen Befehl net ausféieren'; // cpg1.5
$lang_banning_php['lookup_ip'] = 'IP Adress Lookup';
$lang_banning_php['select_date'] = 'Datum auswielen';
$lang_banning_php['delete_comments'] = 'Commentairen läschen'; // cpg1.5
$lang_banning_php['current'] = 'aktuell'; // cpg1.5
$lang_banning_php['all'] = 'all'; // cpg1.5
$lang_banning_php['none'] = 'keen'; // cpg1.5
$lang_banning_php['view'] = 'weisen'; // cpg1.5
$lang_banning_php['ban_id'] = 'Spär ID'; // cpg1.5
$lang_banning_php['existing_bans'] = 'Existent Spären'; // cpg1.5
$lang_banning_php['no_banning_when_bridged'] = 'Är Galerie leeft am Bridge Mode an ass sou mat enger anerer Applikatioun verbonnen. Benotzt den Spär Mechanissem vun dëser Applikatioun fir User ze spären.'; // cpg1.5
$lang_banning_php['records_on_page'] = '%d Elementer op %d Säit(en)'; // cpg1.5
$lang_banning_php['ascending'] = 'opsteigend'; // cpg1.5
$lang_banning_php['descending'] = 'ofsteigend'; // cpg1.5
$lang_banning_php['sort_by'] = 'Sortéieren no'; // cpg1.5
$lang_banning_php['sorted_by'] = 'sortéiert no'; // cpg1.5
$lang_banning_php['ban_record_x_updated'] = 'Spär Element %s ass upgedated ginn'; // cpg1.5
$lang_banning_php['ban_record_x_deleted'] = 'Spär Element %s ass geläscht ginn'; // cpg1.5
$lang_banning_php['new_ban_record_created'] = 'Nei Spär ass ageriicht ginn'; // cpg1.5
$lang_banning_php['ban_record_x_already_exists'] = 'Spär Element fir %s besteet schon!'; // cpg1.5
$lang_banning_php['comment_deleted'] = '%s Commentaire geschriwwen vun %s ass geläscht ginn'; // cpg1.5
$lang_banning_php['comments_deleted'] = '%s Commentaire geschriwwen vun %s sinn geläscht ginn'; // cpg1.5
$lang_banning_php['email_field_invalid'] = 'Gidd w.e.g. eng gülteg E-Mail Adress an'; // cpg1.5
$lang_banning_php['ip_address_field_invalid'] = 'Gidd w.e.g. eng gülteg IP Adress (x.x.x.x) an'; // cpg1.5
$lang_banning_php['expiry_field_invalid'] = 'Gidd w.e.g. eng gülteg Datum (YYYY-MM-DD) an'; // cpg1.5
$lang_banning_php['form_not_submit'] = 'Den Formulaire ass net fortgeschéckt ginn - et ginn nach Fehler, behieft dës fir d\'éischt!'; // cpg1.5
};
...
$lang_calendar_php['title'] = 'Kalenner';
$lang_calendar_php['clear_date'] = 'Datum läschen';
...
$lang_catmgr_php['unknown_cat'] = 'Déi ausgewielte Kategorie existéiert net an der Datebank';
$lang_catmgr_php['usergal_cat_ro'] = 'User Galerie Kategorien kennen net geläscht ginn!';
$lang_catmgr_php['manage_cat'] = 'Kategorien verwalten';
$lang_catmgr_php['confirm_delete'] = 'Sidd dir sécher dass dir dës Kategorie läschen wëllt'; // js-alert
$lang_catmgr_php['category'] = 'Kategorien'; // cpg1.5
$lang_catmgr_php['operations'] = 'Operatiounen';
$lang_catmgr_php['move_into'] = 'Beweegen Richtung';
$lang_catmgr_php['update_create'] = 'Kategorie Updaten/Erstellen';
$lang_catmgr_php['parent_cat'] = 'Haaptkategorie';
$lang_catmgr_php['cat_title'] = 'Kategorie Titel';
$lang_catmgr_php['cat_thumb'] = 'Kategorie Thumbnail';
$lang_catmgr_php['cat_desc'] = 'Kategorie Beschreiwung';
$lang_catmgr_php['categories_alpha_sort'] = 'Kategorien alphabetesch sortéieren (an der Plaatz vun Benotzer definéiertem sortéieren)';
$lang_catmgr_php['save_cfg'] = 'Konfiguratioun späicheren';
$lang_catmgr_php['no_category'] = '* Keng Kategorie *'; // cpg1.5
$lang_catmgr_php['group_create_alb'] = 'Gruppen hunn d\'Erlaabnis Albumen an dëser Kategorie ze erstellen'; // cpg1.5
}
...
$lang_contact_php['your_name'] = 'Ären Numm'; // cpg1.5
$lang_contact_php['your_email'] = 'Är E-Mail Adress'; // cpg1.5
$lang_contact_php['subject'] = 'Sujet'; // cpg1.5
$lang_contact_php['your_message'] = 'Är Noriicht'; // cpg1.5
$lang_contact_php['name_field_mandatory'] = 'Gidd w.e.g. ären Numm un'; // cpg1.5 // js-alert
$lang_contact_php['name_field_invalid'] = 'Gidd w.e.g. ären Numm an'; // cpg1.5 // js-alert
$lang_contact_php['email_field_mandatory'] = 'Gidd w.e.g. är E-Mail Adress un'; // cpg1.5 // js-alert
$lang_contact_php['email_field_invalid'] = 'Gidd w.e.g. eng korrekt E-Mail Adress an'; // cpg1.5 // js-alert
$lang_contact_php['subject_field_mandatory'] = 'Gidd w.e.g. en Sujet an'; // cpg1.5 // js-alert
$lang_contact_php['message_field_mandatory'] = 'Gidd w.e.g. är Noriicht an'; // cpg1.5 // js-alert
$lang_contact_php['confirmation'] = 'Bestätegungs Code'; // cpg1.5
$lang_contact_php['email_headline'] = 'Dës E-mail ass den %s iwwert den Kontakt Formulaire %s vun der IP Adress %s verschéckt ginn'; // cpg1.5
$lang_contact_php['registered_user'] = 'Registréieren User'; // cpg1.5
$lang_contact_php['guest'] = 'Gaascht'; // cpg1.5
$lang_contact_php['unknown'] = 'Onbekannt'; // cpg1.5
$lang_contact_php['user_info'] = 'Den %s mam Numm %s mat der E-Mail Adress %s huet folgendes geschriwen:'; // cpg1.5
$lang_contact_php['failed_sending_email'] = 'Beim verschécken vun ärer E-Mail ass en Fehler opgetruede. Versicht et w.e.g. spéider nach een mol.'; // cpg1.5
$lang_contact_php['email_sent'] = 'Är E-Mail gouf verschéckt.'; // cpg1.5
}
...
$lang_admin_php['title'] = 'Galerie Konfiguratioun';
$lang_admin_php['general_settings'] = 'Allgemeng Astellungen'; // cpg1.5
$lang_admin_php['language_charset_settings'] = 'Sprooch &amp; Charset Astellungen'; // cpg1.5
$lang_admin_php['themes_settings'] = 'Themes Astellungen'; // cpg1.5
$lang_admin_php['album_list_view'] = 'Ausgesinn vun der Album Lescht'; // cpg1.5
$lang_admin_php['thumbnail_view'] = 'Ausgesinn vun der Thumbnail Vue'; // cpg1.5
$lang_admin_php['image_view'] = 'Ausgesinn vun der Bild Vue'; // cpg1.5
$lang_admin_php['comment_settings'] = 'Commentaire Astellungen'; // cpg1.5
$lang_admin_php['thumbnail_settings'] = 'Thumbnail Astellungen'; // cpg1.5
$lang_admin_php['file_settings'] = 'Datei Astellungen'; // cpg1.5
$lang_admin_php['image_watermarking'] = 'Waasserzeechen'; // cpg1.5
$lang_admin_php['registration'] = 'Registratioun'; // cpg1.5
$lang_admin_php['user_settings'] = 'Benotzer Astellungen'; // cpg1.5
$lang_admin_php['custom_fields_user_profile'] = 'Extra Felder fir den User Profil (eidel loossen wann net gebraucht). Benotzt den Profil 6 fir laang Anträg, wéi z.B. Biographie'; // cpg1.5
$lang_admin_php['custom_fields_image_description'] = 'Extra Felder fir den Bild Beschreiwung (eidel loossen wann net gebraucht)'; // cpg1.5
$lang_admin_php['cookie_settings'] = 'Cookies Astellungen'; // cpg1.5
$lang_admin_php['email_settings'] = 'E-Mail Astellungen (normalerweis sinn hei keng Changementer néideg; einfach eidel loossen wann dir net sécher sidd)'; // cpg1.5
$lang_admin_php['logging_stats'] = 'Logging  and Statistiken'; // cpg1.5
$lang_admin_php['maintenance_settings'] = 'Maintenance Astellungen'; // cpg1.5
$lang_admin_php['manage_exif'] = 'EXIF  Daten verwalten';
$lang_admin_php['manage_plugins'] = 'Plugins verwalten';
$lang_admin_php['manage_keyword'] = 'Keyword  verwalten';
$lang_admin_php['restore_cfg'] = 'Op Original Astellungen zerécksetzen';
$lang_admin_php['restore_cfg_confirm'] = 'Wëllt dir wierklech op d\'Original Astellungen zerécksetzen? Heibäi ginn all är Astellungen geläscht! Dëst kann net réckgängeg gemaach ginn!'; // cpg1.5 // js-alert
$lang_admin_php['save_cfg'] = 'Nei Konfiguratioun späicheren';
$lang_admin_php['notes'] = 'Notizen';
$lang_admin_php['info'] = 'Informatiounen';
$lang_admin_php['upd_success'] = 'D\'Coppermine Konfiguratioun ass geupdatet ginn';
$lang_admin_php['restore_success'] = 'D\'Coppermine Original Konfiguratioun ass rëm aktiv';
$lang_admin_php['name_a'] = 'Numm opsteigend';
$lang_admin_php['name_d'] = 'Numm ofsteigend';
$lang_admin_php['title_a'] = 'Titel opsteigend';
$lang_admin_php['title_d'] = 'Titel ofsteigend';
$lang_admin_php['date_a'] = 'Datum opsteigend';
$lang_admin_php['date_d'] = 'Datum ofsteigend';
$lang_admin_php['pos_a'] = 'Positioun opsteigend';
$lang_admin_php['pos_d'] = 'Positioun ofsteigend';
$lang_admin_php['th_any'] = 'Max Aspect';
$lang_admin_php['th_ht'] = 'Héicht';
$lang_admin_php['th_wd'] = 'Breet';
$lang_admin_php['th_ex'] = 'Exakt'; // cpg1.5
$lang_admin_php['debug_everyone'] = 'Jiddereen';
$lang_admin_php['debug_admin'] = 'Just Admin';
$lang_admin_php['no_logs'] = 'Aus';
$lang_admin_php['log_normal'] = 'Normal';
$lang_admin_php['log_all'] = 'All';
$lang_admin_php['view_logs'] = 'Weis d\'Log  Dateien';
$lang_admin_php['click_expand'] = 'Klick op den Sectiounen Numm fir auszeklappen';
$lang_admin_php['click_collapse'] = 'Klick op den Sectiounen Numm fir zouzeklappen'; // cpg1.5
$lang_admin_php['expand_all'] = 'All ausklappen';
$lang_admin_php['toggle_all'] = 'Toggle All'; // cpg1.5
$lang_admin_php['notice1'] = '(*) Dës Astellungen däerfen net méi geännert ginn, wann schonns Dateien an der Datebank sinn.';
$lang_admin_php['notice2'] = '(**) Wann dir dës Astellung ännert, sinn just Dateien dir dir ab elo bäisetzt  betraff, dofir as et rotsam, wann schonns Dateien an der Galerie sinn, dës Astellung net méi ze änneren. Näischt desto  trotz kënnt dir Ännerungen un existéierenden Dateien mam &quot;<a href=&quot;util.php&quot;>admin  tools</a>  (Gréisst vun den Biller änneren)&quot; maachen.';
$lang_admin_php['notice3'] = '(***) All Log  Files ginn op Englesch geschriwwen.';
$lang_admin_php['bbs_disabled'] = 'Dës Funktioun ass net aktiv wann dir den bridging/integration Mode benotzt';
$lang_admin_php['auto_resize_everyone'] = 'Jiddereen';
$lang_admin_php['auto_resize_user'] = 'Just Benotzer';
$lang_admin_php['ascending'] = 'opsteigend';
$lang_admin_php['descending'] = 'ofsteigend';
$lang_admin_php['collapse_all'] = 'Collapse all'; // cpg1.5
$lang_admin_php['separate_page'] = 'op enger separater Säit'; // cpg1.5
$lang_admin_php['inline'] = 'inline'; // cpg1.5
$lang_admin_php['guests_only'] = 'Just Gäscht'; // cpg1.5
$lang_admin_php['wm_bottomright'] = 'Ennen riets'; // cpg1.5
$lang_admin_php['wm_bottomleft'] = 'Ennen lénks'; // cpg1.5
$lang_admin_php['wm_topleft'] = 'Uewen lénks'; // cpg1.5
$lang_admin_php['wm_topright'] = 'Uewen riets'; // cpg1.5
$lang_admin_php['wm_center'] = 'An der Mëtt'; // cpg1.5
$lang_admin_php['wm_both'] = 'Béides'; // cpg1.5
$lang_admin_php['wm_original'] = 'Original'; // cpg1.5
$lang_admin_php['wm_resized'] = 'Resized'; // cpg1.5
$lang_admin_php['gallery_name'] = 'Numm vun der Galerie'; // cpg1.5
$lang_admin_php['gallery_description'] = 'Galerie Beschreiwung'; // cpg1.5
$lang_admin_php['gallery_admin_email'] = 'Galerie Administrator E-Mail'; // cpg1.5
$lang_admin_php['ecards_more_pic_target'] = 'URL vun ärem Coppermine Galerie Folder'; // cpg1.5
$lang_admin_php['ecards_more_pic_target_detail'] = '(mat engem ofschléissenden Slash, keen \'index.php\' oder ähnleches um Schluss)'; // cpg1.5
$lang_admin_php['home_target'] = 'URL vun ärer Homepage'; // cpg1.5
$lang_admin_php['enable_zipdownload'] = 'ZIP-Download vun den Favoriten erlaben'; // cpg1.5
$lang_admin_php['enable_zipdownload_no_textfile'] = 'just d\'Favoriten'; // cpg1.5
$lang_admin_php['enable_zipdownload_additional_textfile'] = 'Favoriten an Readme Dateien'; // cpg1.5
$lang_admin_php['time_offset'] = 'Zäitzonen  Ënnerscheet relativ zu GMT'; // cpg1.5
$lang_admin_php['time_offset_detail'] = '(aktuell Zäit: %s)'; // cpg1.5
$lang_admin_php['enable_help'] = 'Aktivéier Hëllef Icons'; // cpg1.5
$lang_admin_php['enable_help_description'] = 'help partially available in English only'; // cpg1.5
$lang_admin_php['clickable_keyword_search'] = 'Schalt klickbar Keywords an der Sich an'; // cpg1.5
$lang_admin_php['keyword_separator'] = 'Keyword Trennzeechen'; // cpg1.5
$lang_admin_php['keyword_convert'] = 'Konvertéier Keyword Trennzeechen'; // cpg1.5
$lang_admin_php['enable_plugins'] = 'Plugins aschalten'; // cpg1.5
$lang_admin_php['purge_expired_bans'] = 'Automatically purge expired bans'; // cpg1.5
$lang_admin_php['browse_batch_add'] = 'Duerchsichbaren Batch-Add Interface'; // cpg1.5
$lang_admin_php['batch_proc_limit'] = 'Process concurrency for batch-add interface'; // cpg1.5
$lang_admin_php['display_thumbs_batch_add'] = 'Weis d\'Thumbnails  am Batch-Add Interface'; // cpg1.5
$lang_admin_php['lang'] = 'Standard Sprooch'; // cpg1.5
$lang_admin_php['language_autodetect'] = 'Sprooch automatesch astellen'; // cpg1.5
...
$lang_db_ecard_php['title'] = 'E-Kaartverschécken';
...
$lang_db_ecard_php['ecard_name'] = 'Numm';
$lang_db_ecard_php['ecard_email'] = 'E-Mail';
$lang_db_ecard_php['ecard_ip'] = 'IP';
$lang_db_ecard_php['ecard_ascending'] = 'opsteigend';
$lang_db_ecard_php['ecard_descending'] = 'ofsteigend';
$lang_db_ecard_php['ecard_sorted'] = 'Sortéiert';
$lang_db_ecard_php['ecard_by_date'] = 'No Datum';
...
$lang_db_ecard_php['ecard_goto_page'] = 'géi op d\'Säit';
$lang_db_ecard_php['ecard_records_per_page'] = 'Elementer pro Säit';
$lang_db_ecard_php['check_all'] = 'All Auswielen';
$lang_db_ecard_php['uncheck_all'] = 'Näischt Auswielen';
$lang_db_ecard_php['ecards_delete_selected'] = 'Läsch déi ausgewielten E-Kaarten';
$lang_db_ecard_php['ecards_delete_confirm'] = 'Are you sure you want to delete the records? Tick the checkbox!';
$lang_db_ecard_php['ecards_delete_sure'] = 'Jo ech sinn sécher';
$lang_db_ecard_php['invalid_data'] = 'Déi E-Kaart déi dir kucken wëllt, ass duerch ären E-Mail Programm verännert ginn. Kontrolléiert dësen op den Link komplett ass.';
}
...
$lang_db_input_php['empty_name_or_com'] = 'Dir musst ären Numm an en Commentaire uginn';
$lang_db_input_php['com_added'] = 'Ären Commentaire ass bäigesat ginn'; // cpg1.5
$lang_db_input_php['alb_need_title'] = 'Dir musst en Titel fir den Album uginn!';
$lang_db_input_php['no_udp_needed'] = 'Update ass net noutwenneg.';
$lang_db_input_php['alb_updated'] = 'Den Album ass geupdatet ginn';
$lang_db_input_php['unknown_album'] = 'Den gewieltenen Album existéiert net oder dir hutt keng Rechter fir Dateien an dësen Album ze lueden';
$lang_db_input_php['no_pic_uploaded'] = 'Et ass keng Datei erop gelueden ginn. <br />Wann dir wierklech eng Datei auswielt hat fir eropzelueden, dann kontrolléiert är Server Astellungen...';
$lang_db_input_php['err_mkdir'] = 'Folgend Kategorie konnt net erstallt ginn: %s!';
$lang_db_input_php['dest_dir_ro'] = 'Den Skript kann net an d\'Destinatioun\'s Verzeechnis %s schreiwen!';
$lang_db_input_php['err_move'] = 'Onméiglech vun %s op %s ze beweegen!';
$lang_db_input_php['err_fsize_too_large'] = 'D\'Gréisst vun der Datei déi dir eropgelueden hutt ass ze grouss (erlaabten Maximum ass %s x %s)!';
$lang_db_input_php['err_imgsize_too_large'] = 'D\'Gréisst vun der Datei déi dir eropgelueden hutt ass ze grouss (erlaabten Maximum ass %s KB)!';
$lang_db_input_php['err_invalid_img'] = 'Déi Datei déi dir eropgelueden hutt ass keen valabelt Bild!';
$lang_db_input_php['allowed_img_types'] = 'Dir kennt just %s Biller eroplueden.';
$lang_db_input_php['err_insert_pic'] = 'Datei \'%s\' konnt net an den Album bäigesat ginn ';
$lang_db_input_php['upload_success'] = 'Är Datei ass mat Succès eropgelueden ginn. <br />Dës gëtt siichtbar, nodeems en Administrator dës validéiert huet.';
$lang_db_input_php['notify_admin_email_subject'] = '%s - Néi Datei Notificatioun';
$lang_db_input_php['notify_admin_email_body'] = 'E Bild ass vum %s eropgelueden ginn, wat nach iwwerpréift muss ginn. Gidd op d\'Säit %s';
$lang_db_input_php['info'] = 'Informatioun';
$lang_db_input_php['com_added'] = 'Commentaire bäigesat';
$lang_db_input_php['com_updated'] = 'Commentaire geännert'; // cpg1.5
$lang_db_input_php['alb_updated'] = 'Album geännert';
$lang_db_input_php['err_comment_empty'] = 'Ären Commentaire ass eidel!';
$lang_db_input_php['err_invalid_fext'] = 'Et sinn just Dateien mat folgenden Endungen erlaabt:'; // js-alert
$lang_db_input_php['no_flood'] = 'Die sidd den Verfaasser vun dem lëschten Commentaire <br/>Editéiert ären leschten Commentaire wann dir en veränneren wëllt';
$lang_db_input_php['redirect_msg'] = 'Dir gitt weidergeleet.<br /><br />Klickt op \'CONTINUE\' wann d\'Säit net automatesch kënnt.';
$lang_db_input_php['upl_success'] = 'Är Datei ass bäigesat ginn';
$lang_db_input_php['email_comment_subject'] = 'Neien Commentaire an ärer Galerie';
$lang_db_input_php['email_comment_body'] = 'Et huet een en Commentaire an ärer Galerie geschriwwen. Kuckt en op';
$lang_db_input_php['album_not_selected'] = 'Album net ausgewielt';
$lang_db_input_php['com_author_error'] = 'En registréierten User benotz dësen Nickname. Logged iech an oder benotzt en aneren';
}
...
$lang_display_image_php['confirm_del'] = 'Sidd dir sécher dass dir dës Datei läschen wëllt? \\n Commentairen ginn mat geläscht.'; // js-alert
$lang_display_image_php['del_pic'] = 'Datei läschen';
$lang_display_image_php['size'] = '%s x %s Pixel';
$lang_display_image_php['views'] = '%s mol';
$lang_display_image_php['slideshow'] = 'Slideshow';
$lang_display_image_php['stop_slideshow'] = 'Stopp d\'Slideshow';
$lang_display_image_php['view_fs'] = 'Hei klicken fir d\'Bild an voller Gréisst ze gesinn';
$lang_display_image_php['edit_pic'] = 'Datei Informatiounen beschafen';
$lang_display_image_php['crop_pic'] = 'Beschneiden an Dréinen';
$lang_display_image_php['set_player'] = 'Player wiesselen';

$lang_picinfo['title'] = 'Datei Informatiounen';
$lang_picinfo['Album name'] = 'Album Numm';
$lang_picinfo['Rating'] = 'Bewäertung (%s Stëmmen)';
$lang_picinfo['Date Added'] = 'Eropgelueden';
$lang_picinfo['Dimensions'] = 'Dimensiounen';
$lang_picinfo['Displayed'] = 'Ugewisen';
$lang_picinfo['URL'] = 'URL';
$lang_picinfo['Make'] = 'Hiersteller';
$lang_picinfo['Model'] = 'Model';
$lang_picinfo['DateTime'] = 'Datum Auerzäit';
$lang_picinfo['ISOSpeedRatings'] = 'ISO';
$lang_picinfo['MaxApertureValue'] = 'Max Blend';
$lang_picinfo['FocalLength'] = 'Brennwäit';
$lang_picinfo['Comment'] = 'Commentaire';
$lang_picinfo['addFav'] = 'An meng Favoriten bäisetzen';
$lang_picinfo['addFavPhrase'] = 'Favoriten';
$lang_picinfo['remFav'] = 'Aus meng Favoriten läschen';
...
$lang_picinfo['iptcSubCategories'] = 'IPTC Ënner-Kategorie';
$lang_picinfo['ColorSpace'] = 'Color Space';
$lang_picinfo['ExposureProgram'] = 'Beliichtungsprogramm';
$lang_picinfo['Flash'] = 'Blëtz';
$lang_picinfo['MeteringMode'] = 'Metering Mode';
$lang_picinfo['ExposureTime'] = 'Beliichtungszäit';
$lang_picinfo['ExposureBiasValue'] = 'Exposure Bias';
$lang_picinfo['ImageDescription'] = 'Bild Beschreiwung';
$lang_picinfo['Orientation'] = 'Orientatioun';
$lang_picinfo['xResolution'] = 'X Opléisung';
$lang_picinfo['yResolution'] = 'Y Opléisung';
$lang_picinfo['ResolutionUnit'] = 'Opléisungseenheet';
...
$lang_picinfo['FNumber'] = 'Blend';
$lang_picinfo['ExifVersion'] = 'EXIF Versioun';
$lang_picinfo['DateTimeOriginal'] = 'Original Datum Auerzäit';
$lang_picinfo['DateTimedigitized'] = 'Digitaliséierung Datum Auerzäit';
...
$lang_picinfo['LightSource'] = 'Liichtquell';
$lang_picinfo['ISOSetting'] = 'ISO Astellung';
$lang_picinfo['ColorMode'] = 'Faarfmodus';
$lang_picinfo['Quality'] = 'Qualitéit';
$lang_picinfo['ImageSharpening'] = 'Bildschäerfung';
$lang_picinfo['FocusMode'] = 'Focus Modus';
$lang_picinfo['FlashSetting'] = 'Blëtz Astellung';
$lang_picinfo['ISOSelection'] = 'ISO Astellung';
$lang_picinfo['ImageAdjustment'] = 'Bild Astellung';
$lang_picinfo['Adapter'] = 'Adapter';
$lang_picinfo['ManualFocusDistance'] = 'Manuelle Fokus Ofstand';
$lang_picinfo['DigitalZoom'] = 'Digitale Zoom';
$lang_picinfo['AFFocusPosition'] = 'AF Fokus Positioun';
$lang_picinfo['Saturation'] = 'Saturatioun';
$lang_picinfo['NoiseReduction'] = 'Rauschënnerdréckung';
$lang_picinfo['FlashPixVersion'] = 'FlashPix Versioun';
$lang_picinfo['ExifImageWidth'] = 'EXIF Bild Breet';
$lang_picinfo['ExifImageHeight'] = 'EXIF Bild Héicht';
...
$lang_picinfo['ExposureMode'] = 'Beliichtungmodus';
$lang_picinfo['WhiteBalance'] = 'Wäissofglaich';
$lang_picinfo['DigitalZoomRatio'] = 'Digitale Zoom Verhältnis';
$lang_picinfo['SceneCaptureMode'] = 'Scene Capture Mode';
$lang_picinfo['GainControl'] = 'Gain Control';
$lang_picinfo['Contrast'] = 'Kontrast';
$lang_picinfo['Sharpness'] = 'Schäerft';
$lang_picinfo['ManageExifDisplay'] = 'Manage EXIF Display';
$lang_picinfo['success'] = 'D\'Informatiounen sinn erfollegräich gespäichert ginn.';
$lang_picinfo['show_details'] = 'Weis Detailer'; // cpg1.5
$lang_picinfo['hide_details'] = 'Verstopp Detailer'; // cpg1.5
$lang_picinfo['download_URL'] = 'Direkten Link';
$lang_picinfo['movie_player'] = 'Spill Datei an denger Standard Applikatioun';

$lang_display_comments['comment_x_to_y_of_z'] = '%d bis %d vun %d'; // cpg1.5
$lang_display_comments['page'] = 'Säit'; // cpg1.5
$lang_display_comments['edit_title'] = 'Dësen Commentaire beaarbechten';
$lang_display_comments['delete_title'] = 'Dësen Commentaire läschen'; // cpg1.5
$lang_display_comments['confirm_delete'] = 'Sidd dir sécher, dësen Commentaire ze läschen?'; // js-alert
$lang_display_comments['add_your_comment'] = 'Ären Commentaire bäisetzen';
$lang_display_comments['name'] = 'Numm';
$lang_display_comments['comment'] = 'Commentaire';
$lang_display_comments['your_name'] = 'Anon';
$lang_display_comments['report_comment_title'] = 'Dësen Commentaire dem Administrator mëllen';
$lang_display_comments['pending_approval'] = 'Comment will be visible after admin approval'; // cpg1.5
$lang_display_comments['unapproved_comment'] = 'Nach net iwwerpréiften Commentaire'; // cpg1.5
$lang_display_comments['pending_approval_message'] = 'Et gouf en Commentaire geschriwwen. Dësen ass no der Iwwerpréifung duerch an Administrator siichtbar.'; // cpg1.5
$lang_display_comments['approve'] = 'Commentaire iwwerpréiften'; // cpg1.5
$lang_display_comments['disapprove'] = 'Commentaire als net iwwerpréift markéieren'; // cpg1.5
$lang_display_comments['log_in_to_comment'] = 'Anonym Commentairen sinn net erlaabt.%sLog in%s fir ären Commentaire fort zeschécken'; // cpg1.5 // do not translate the %s placeholders - they will be used as wrappers for the link (<a>)
$lang_display_comments['default_username_message'] = 'Gidd w.e.g. ären Numm un'; // cpg1.5
$lang_display_comments['comment_rejected'] = 'Ären Commentaire ass refuséiert ginn'; // cpg1.5

$lang_fullsize_popup['click_to_close'] = 'Klick op d\'Bild fir d\'Fënster zou maachen';
$lang_fullsize_popup['close_window'] = 'Fënster zou maachen'; // cpg1.5
}
...
$lang_ecard_php['title'] = 'Eng E-Kaart verschécken';
$lang_ecard_php['invalid_email'] = 'Warnung: E-Mail Adress ass net korrekt:'; // cpg1.5
$lang_ecard_php['ecard_title'] = 'Eng E-Kaart vum %s fir iech';
$lang_ecard_php['error_not_image'] = 'Et kennen just Biller als E-Kaart verschéckt ginn.'; // cpg1.5
$lang_ecard_php['error_not_image_flash'] = 'Et kennen just Biller an Flash Dateien als E-Kaart verschéckt ginn.'; // cpg1.5
$lang_ecard_php['view_ecard'] = 'Alternativen Link, wann d\'E-Kaart net richteg ugewisen kann ginn';
$lang_ecard_php['view_ecard_plaintext'] = 'Fir d\'E-Kaart ze kucken, copéiert dësen Link an är Browser Adress Bar:';
$lang_ecard_php['view_more_pics'] = 'Kuckt méi Biller!';
$lang_ecard_php['send_success'] = 'Är E-Kaart ass verschéckt ginn';
$lang_ecard_php['send_failed'] = 'Et deet eis leet, mä den Server kann äre E-Kaart net verschécken...';
$lang_ecard_php['from'] = 'Vum';
$lang_ecard_php['your_name'] = 'Ären Numm';
$lang_ecard_php['your_email'] = 'Är E-Mail Adress';
$lang_ecard_php['to'] = 'Un';
$lang_ecard_php['rcpt_name'] = 'Numm vum Empfänger';
$lang_ecard_php['rcpt_email'] = 'E-Mail Adress vum Empfänger';
$lang_ecard_php['greetings'] = 'Iwwerschrëft';
$lang_ecard_php['message'] = 'Noriicht';
$lang_ecard_php['ecards_footer'] = 'Verschéckt vum %s iwwert d\'IP %s um %s (Galerie Zäit)';
$lang_ecard_php['preview'] = 'E-Kaart ukucken';
$lang_ecard_php['preview_button'] = 'Preview';
$lang_ecard_php['submit_button'] = 'E-Kaart verschécken';
$lang_ecard_php['preview_view_ecard'] = 'Dëst ass den alternativer Link zu der E-Kaart, wann dës bis erstallt ass. Dëst geet net fir Previews.';
}
...
$lang_report_php['title'] = 'Dem Administrator mellen';
$lang_report_php['invalid_email'] = '<strong>Warnung</strong> : keng gülteg E-Mail Adress!';
$lang_report_php['report_subject'] = 'Eng Meldung vun %s aus der Galerie %s';
$lang_report_php['view_report'] = 'Alternativen Link, wann den Rapport net korrekt ugewisen gëtt';
$lang_report_php['view_report_plaintext'] = 'Fir den Rapport ze gesinn, maacht en Copy / Paste  vun dëser Adress an ären Browser:';
$lang_report_php['view_more_pics'] = 'Galerie';
$lang_report_php['send_success'] = 'Ären Rapport ass verschéckt ginn';
$lang_report_php['send_failed'] = 'Et deet eis leet, mäi den Server kann ären Rapport net verschécken...';
$lang_report_php['from'] = 'Vun';
$lang_report_php['your_name'] = 'Ären Numm';
$lang_report_php['your_email'] = 'Är E-mail Adress';
$lang_report_php['to'] = 'Fir';
$lang_report_php['administrator'] = 'Administrator/Moderator';
$lang_report_php['subject'] = 'Sujet';
$lang_report_php['comment_field_name'] = 'Meldung vun engem Commentaire vum "%s"';
$lang_report_php['reason'] = 'Grond';
$lang_report_php['message'] = 'Message';
$lang_report_php['report_footer'] = 'Verschéckt vum %s iwwert d\'IP %s um %s (Galerie Zäit)';
$lang_report_php['obscene'] = 'ustoussend';
$lang_report_php['offensive'] = 'ugräifend';
$lang_report_php['misplaced'] = 'off-topic/dernieft';
$lang_report_php['missing'] = 'fehlt';
$lang_report_php['issue'] = 'Fehler/kann net ugewisen ginn';
$lang_report_php['other'] = 'aneren Grond';
$lang_report_php['refers_to'] = 'Datei gehéiert zu';
$lang_report_php['reasons_list_heading'] = 'Grond/Grënn fir d\'Meldung:';
$lang_report_php['no_reason_given'] = 'et ass keen Grond uginn';
$lang_report_php['go_comment'] = 'gitt bei d\'Commentairen';
$lang_report_php['view_comment'] = 'kuckt den ganzen Rapport mat Commentairen';
$lang_report_php['type_file'] = 'Datei';
$lang_report_php['type_comment'] = 'Commentaire';
$lang_report_php['invalid_data'] = 'Daten vum Rapport wou dir kucken wëllt, sinn vun arem Mail Programm falsch interpretéiert  ginn. Kuckt w.e.g. ob den Link komplett ass.';
}
