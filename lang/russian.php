...
$lang_translation_info['trans_date'] = '2010-09-21';
...
$lang_errors['captcha_error'] = 'Код подтверждения не совпадает'; // cpg1.5
...
$lang_common['keywords_insert1'] = 'Ключевые слова (разделитель %s)'; // cpg1.5
...
$lang_banning_php['user_account'] = 'Учётная запись пользователя'; // cpg1.5 (??)
...
$lang_admin_php['language_autodetect'] = 'Автоматическое определение языка'; // cpg1.5
$lang_admin_php['charset'] = 'Кодировка символов'; // cpg1.5
// 'previous_next_tab'] = 'Отображать предыдущий/следующий на страницах с закладками'; // cpg1.5
...
$lang_admin_php['upl_notify_admin_email'] = 'Уведомлять администратора об ожидающей подтверждения загрузке пользователя'; // cpg1.5
...
$lang_admin_php['manage_languages'] = 'Менеджер языков'; // cpg1.5
...
$lang_editpics_php['n_pic'] = 'Файлов: %s';
...
$lang_editpics_php['thumbnail_view'] = 'Перейти к миниатюрам';
...
$lang_list_users['no_user_gal'] = 'Отсутствуют галереи пользователей';
...
$lang_install['im_not_found'] = 'Установка попыталась найти ImageMagick, но не смогла обнаружить наличие или произошла ошибка. <br />Coppermine может использовать программу <a href="http://www.imagemagick.org/">ImageMagick</a> \'convert\' для создания миниатюр. Качество изображений создаваемых ImageMagick превосходит GD1, но эквивалентно GD2.<br />Если ImageMagick установлен в Вашей системе и Вы хотите его использовать, <br />Вам необходимо указать ниже полный путь к программе \'convert\'. <br />В Windows полный путь должен выглядеть как \'c:/ImageMagick/\' и не должен содержать в себе никаких пробелов, в Unix должен выглядеть как \'/usr/bin/\'.<br />Если Вы не знаете, установлен ли у Вас ImageMagick или нет, оставьте это поле пустым - установка тогда попытается использовать библиотеку GD2 по умолчанию (которая есть у большинства пользователей). <br />Вы можете изменить это позднее (в настройках Coppermine), поэтому не беспокойтесь, если Вы не знаете, что тут вводить - оставьте пустым.';
$lang_install['im_packages'] = 'Ваш сервер поддерживает следующие пакеты изображений';
$lang_install['im_path'] = 'Путь к ImageMagick:';
$lang_install['im_path_space'] = 'Путь к ImageMagick (\'%s\') содержит, по крайней мере, один пробел. В дальнейшем это вызовёт проблемы в скрипте.<br />Вы должны переместить ImageMagick в другую директорию.';
...
$lang_install['mysql_succ'] = 'Успешное подключение к базе данных';
...
$lang_install['please_go_back'] = 'Пожалуйста, %sнажмите здесь %s, чтобы перейти назад и исправить данную проблему, прежде чем продолжить.';
...
$lang_install['title_welcome'] = 'Добро пожаловать в установку Coppermine';
...
$lang_install['no_cookie'] = 'Ваш браузер не принимает наш cookie. Рекомендуется принимать cookie.';
...
$lang_install['scale_error'] = 'Не могу масштабировать исходное изображение';
$lang_install['pixels'] = 'пикселей';
$lang_install['combine'] = 'Сравнить 2 изображения';
$lang_install['text'] = 'Записать текст на изображение';
$lang_install['scale'] = 'Масштабировать изображение';
...
$lang_install['old_install'] = 'Это новый мастер установки. Нажмите %sздесь%s для классического экрана установки.'; //cpg1.5
...
$lang_modifyalb_php['notice1'] = '(*) в зависимости от настроек %sгрупп%s'; // do not translate the %s placeholders
...
$lang_register_php['user_name_banned'] = 'Имя пользователя, которое Вы выбрали, запрещено/заблокировано. Выберите другое имя пользователя'; // cpg1.5
...
$lang_reviewcom_php['approve'] = 'подтвердить'; // cpg1.5
...
$lang_sidebar_php['os_browser_detect_explain'] = 'Скрипт пытается определить Вашу операционную систему и версию браузера - пожалуйста, подождите. Если авто-определение потерпело неудачу, Вы можете самостоятельно %sотобразить%s все возможные варианты установки боковых панелей.'; // cpg1.5
...
$lang_sidebar_php['ie7_win_explain'] = 'Если Вы используете Internet Explorer 7 в Windows, Вы можете добавить всплывающее навигационное окно в Вашу панель ссылок, или Вы можете добавить её в Ваше избранное и, нажимая на неё, Вы сможете видеть нашу панель, отображаемую в качестве всплывающего окна, путём правого-клика %sздесь%s и выбором "Добавить в избранное" из контекстного меню. В предыдущих версиях IE было возможно добавить подлинную боковую панель, но в IE7 Вы не можете сделать этого без использование специальных изменений в реестре. Рекомендуется использовать другой браузер, если Вы хотите использовать подлинную боковую панель.'; // cpg1.5
...
$lang_search_new_php['display_thumbs_batch_add'] = 'Отображать миниатюры для предпросмотра'; // cpg1.5
...
$lang_upload_php['up_instr_5'] = 'Вы будете перенаправлены на страницу, где Вы сможете ввести информацию о загруженных файлах. После заполнения полей, отправьте форму используя кнопку "Применить изменения" в самом нижу данной страницы.';
...
$lang_upload_php['err_flash_disabled'] = 'Загрузка интерфейса заняла много времени или загрузка завершилась неудачей. Пожалуйста, убедитесь, что Flash плагин включен и что установлена работающая версия Flash плеера.'; // cpg1.5
...
$lang_upload_swf_php['status_failed'] = 'Загрузка не удалась.'; //cpg1.5
...
$lang_usermgr_php['send_login_data'] = 'Выслать информацию для входа данному пользователю (Пароль будет послан в письме)'; // cpg1.5
...
$lang_update_php['mysql_database_error'] = 'MySQL не может обнаружить базу данных с именем %s'; // cpg1.5
...
$lang_util_php['replace_wait'] = 'Удаляю оригиналы и заменяю их на промежуточные изображения, пожалуйста, подождите...';
...
$lang_util_php['delete_intermediate_explanation1'] = 'Это удалит промежуточные изображения.'; // cpg1.5
...
$lang_util_php['delete_replace'] = 'Удалить оригинальные изображения, заменяя их на промежуточные версии';
...
$lang_xp_publish_php['install_save'] = 'Сохраните файл на Вашем компьютере. Во время сохранения проверьте, что предлагаемое имя файла <tt>cpg_###.reg</tt> (где ### представляет собой цифровой набор времени). Измените его на указанное имя в случае необходимости (не изменяйте цифры)'; // cpg1.5
...
$lang_plugin_php['usergal_alphatabs_config_description'] = 'Что делает: отображает ссылки с буквами от A до Z на верху галереи пользователей, по которым посетители могут сразу перейти на страницу, которая отображают всех пользователей, чьи имена начинаются на выбранную букву. Рекомендуется использовать, если у Вас действительно большое количество галерей пользователей.'; // cpg1.5
...
$lang_plugin_php['onlinestats_config_install'] = 'Плагин выполняет дополнительные запросы в базу данных каждый раз когда он выполняется, нагружая процессор и используя ресурсы. Если Ваша галерея Coppermine работает медленно или в ней много пользователей, Вы не должны использовать данный плагин.';
...
$lang_plugin_php['link_target_description'] = 'Изменяет механизм открытия внешних сссылок: когда данный плагин включен, все ссылки, которые содержат атрибут rel="external", будут открыавться в новом окне (вместо того же окна).';
