...
$lang_translation_info['lang_name_native'] = 'Deutsch (Sie)';
...
$lang_translation_info['trans_date'] = '2009-10-02';
...
$lang_day_of_week = array('So', 'Mo', 'Di', 'Mi', 'Du', 'Fr', 'Sa');
...
$lang_errors['access_denied'] = 'Sie haben kein Recht, diese Seite anzusehen.';
$lang_errors['perm_denied'] = 'Sie haben kein Recht, diese Operation auszuführen.';
...
$lang_errors['quota_exceeded_details'] = 'Sie haben ein Speicherlimit von [quota] kB, Ihre Dateien belegen zur Zeit [space] kB, das Hinzufügen dieser Datei würde Deinen Speicherplatz überschreiten.'; //cpg1.5
$lang_errors['gd_file_type_err'] = 'Bei Verwendung der GD-Bibliothek sind nur die Dateitypen JPG und PNG erlaubt.';
$lang_errors['invalid_image'] = 'Das Bild, das Sie hochgeladen haben, ist beschädigt oder kann nicht von der GD-Bibliothek verarbeitet werden';
$lang_errors['resize_failed'] = 'Kann Thumbnail nicht erzeugen.';
$lang_errors['no_img_to_display'] = 'Keine Datei zum Anzeigen vorhanden (oder Sie haben keine Berechtigung, das Album zu sehen)';
...
$lang_errors['banned'] = 'Sie sind zur Zeit von dieser Seite verbannt.';
$lang_errors['not_with_udb'] = 'Diese Funktion ist innerhalb von Coppermine deaktiviert, weil sie in die Forums-Software integriert ist. Entweder wird das, was Sie gerade zu tun versucht haben, in dieser Konfiguration nicht unterstützt oder die Funktion sollte von der Forums-Software übernommen werden.';
$lang_errors['offline_title'] = 'Wartungsmodus';
$lang_errors['offline_text'] = 'Die Galerie ist zur Zeit im Wartungsmodus - schauen Sie später nochmal vorbei!';
$lang_errors['ecards_empty'] = 'Es können derzeit keine eCard-Einträge gefunden werden. Überprüfen Sie, ob die Aufzeichung von eCards in den Einstellungen aktivert wurde!';
$lang_errors['action_failed'] = 'Aktion fehlgeschlagen. Coppermine konnte die gewünschte Aktion nicht ausführen.';
$lang_errors['no_zip'] = 'Die zum Verarbeiten von ZIP-Dateien notwendigen Bibliotheken sind auf dem Server nicht verfügbar. Setzen Sie sich mit dem Server-Admin in Verbindung.';
...
$lang_errors['page_removed_redirector'] = 'Sie versuchen eine Seite aufzurufen, die aus dem Coppermine-Paket entfernt wurde.<br />Leite um...'; //cpg1.5
...
$lang_errors['login_needed'] = 'Sie müssen sich %sregistrieren%s/%sanmelden%s, um diese Seite anzeigen zu können.'; //cpg1.5
...
$lang_common['captcha_help'] = 'Um Spam zu vermeiden müssen Sie beweisen, dass Sie ein Mensch sind und nicht nur ein Skript. Geben Sie dazu die in der Grafik angezeigten Buchstaben ein.<br />Groß-/Kleinschreibung spielt keine Rolle, Sie können alles in Kleinbuchstaben eingeben.'; // cpg1.5
...
$lang_common['javascript_needed'] = 'Diese Seite benötigt JavaScript. Bitte aktivieren Sie JavaScript in Ihrem Browser.'; // cpg1.5
...
$lang_common['select_album'] = 'Wählen Sie ein Album'; // cpg1.5
...
// File theme.php
// ------------------------------------------------------------------------- //
$lang_main_menu['home_title'] = 'Zur Startseite gehen';
$lang_main_menu['home_lnk'] = 'Startseite';
$lang_main_menu['alb_list_title'] = 'Zur Albenliste gehen';
$lang_main_menu['alb_list_lnk'] = 'Albenliste';
$lang_main_menu['my_gal_title'] = 'Zu meiner persönlichen Galerie gehen';
$lang_main_menu['my_gal_lnk'] = 'Meine Galerie';
$lang_main_menu['my_prof_title'] = 'Zu meinem Profil gehen';
$lang_main_menu['my_prof_lnk'] = 'Mein Profil';
$lang_main_menu['adm_mode_title'] = 'Anzeige der Admin-Menüs aktivieren';
$lang_main_menu['adm_mode_lnk'] = 'Admin-Menü anzeigen';
$lang_main_menu['usr_mode_title'] = 'Anzeige der Admin-Menüs deaktivieren';
...
$lang_main_menu['register_title'] = 'Ein Benutzerkonto erzeugen';
...
$lang_main_menu['lastup_title'] = 'Neueste Uploads anzeigen';
$lang_main_menu['lastup_lnk'] = 'Neueste Uploads';
$lang_main_menu['lastcom_title'] = 'Die neuesten Kommentare anzeigen';
$lang_main_menu['lastcom_lnk'] = 'Neueste Kommentare';
$lang_main_menu['mostcom_title'] = 'Die am meisten kommentierten Dateien anzeigen'; // cpg1.5
$lang_main_menu['mostcom_lnk'] = 'Am meisten kommentiert'; // cpg1.5
$lang_main_menu['topn_title'] = 'Die am meisten angesehenen Dateien anzeigen';
$lang_main_menu['topn_lnk'] = 'Am meisten angesehen';
$lang_main_menu['toprated_title'] = 'Die am besten bewerteten Dateien anzeigen';
$lang_main_menu['toprated_lnk'] = 'Am besten bewertet';
$lang_main_menu['search_title'] = 'Galerie durchsuchen';
$lang_main_menu['search_lnk'] = 'Suche';
$lang_main_menu['fav_title'] = 'Meine Favoriten anzeigen';
...
$lang_main_menu['contact_title'] = 'Treten Sie mit %s in Kontakt'; // cpg1.5
$lang_main_menu['contact_lnk'] = 'Kontakt'; // cpg1.5
$lang_main_menu['sidebar_title'] = 'Füge eine Sidebar zu Ihrem Browser hinzu'; // cpg1.5
...
$lang_gallery_admin_menu['admin_title'] = 'Zur Konfiguration gehen';
$lang_gallery_admin_menu['admin_lnk'] = 'Einstellungen';
$lang_gallery_admin_menu['albums_title'] = 'Zur Alben-Konfiguration gehen';
$lang_gallery_admin_menu['albums_lnk'] = 'Alben';
$lang_gallery_admin_menu['categories_title'] = 'Zur Kategorien-Konfiguration gehen';
$lang_gallery_admin_menu['categories_lnk'] = 'Kategorien';
$lang_gallery_admin_menu['users_title'] = 'Zur Benutzer-Konfiguration gehen';
$lang_gallery_admin_menu['users_lnk'] = 'Benutzer';
$lang_gallery_admin_menu['groups_title'] = 'Zur Gruppen-Konfiguration gehen';
$lang_gallery_admin_menu['groups_lnk'] = 'Gruppen';
$lang_gallery_admin_menu['comments_title'] = 'Alle Kommentare zur Bearbeitung anzeigen';
$lang_gallery_admin_menu['comments_lnk'] = 'Kommentare bearbeiten';
$lang_gallery_admin_menu['searchnew_title'] = 'Zur Stapel-Bearbeitung hochgeladener Dateien gehen';
$lang_gallery_admin_menu['searchnew_lnk'] = 'Batch-hinzufügen';
$lang_gallery_admin_menu['util_title'] = 'Zu den Admin-Werkzeugen gehen';
$lang_gallery_admin_menu['util_lnk'] = 'Admin-Werkzeuge';
$lang_gallery_admin_menu['key_title'] = 'Zum Schlagwort-Register gehen';
$lang_gallery_admin_menu['key_lnk'] = 'Schlagwort-Register';
$lang_gallery_admin_menu['ban_title'] = 'Zur Konfiguration der Verbannungen gehen';
...
$lang_gallery_admin_menu['pictures_title'] = 'Die Reihenfolge von Bildern in Alben bestimmen';
...
$lang_albmgr_php['confirm_modifs'] = 'Sind Sie sicher, dass Sie diese Änderungen durchführen wollen?'; // js-alert
$lang_albmgr_php['no_change'] = 'Sie haben nichts verändert!'; // js-alert
$lang_albmgr_php['new_album'] = 'neues Album';
$lang_albmgr_php['delete_album'] = 'Lösche Album'; // cpg1.5
$lang_albmgr_php['confirm_delete1'] = 'Wollen Sie dieses Album wirklich löschen?'; // js-alert
...
$lang_albmgr_php['category_change'] = 'Wenn Sie die Kategorie ändern gehen Ihre bisherigen Änderungen verloren!'; // cpg1.5
$lang_albmgr_php['cancel'] = 'Abbrechen'; // cpg1.5
$lang_albmgr_php['submit_reminder'] = 'Die Änderungen der Sortierreihenfolge werden nicht gespeichert, bis Sie &quot;Anwenden&quot; geklickt haben.'; // cpg1.5
}
...
$lang_banning_php['error_specify'] = 'Sie müssen entweder einen Benutzer oder eine IP-Adresse angeben';
$lang_banning_php['error_ban_id'] = 'Ungültige Verbannungs-ID!';
$lang_banning_php['error_admin_ban'] = 'Sie können sich nicht selbst verbannen!';
$lang_banning_php['error_server_ban'] = 'Sie wollten Ihren eigenen Server verbannen? Ts ts, das kann ich nicht zulassen...';
$lang_banning_php['skipping'] = 'Diesen Befehl überspringen';
$lang_banning_php['lookup_ip'] = 'IP-Adresse nachschlagen';
$lang_banning_php['submit'] = 'los!';
$lang_banning_php['select_date'] = 'Datum wählen';
...
$lang_banning_php['no_banning_when_bridged'] = 'Ihre Galerie ist zur Zeit mit einer anderen Applikation gebridged. Benutzen Sie die Verbannungsmechanismen der bridge-Applikation anstelle der in Coppermine integrierten Verbannung, da diese bei aktiviertem Bridging kaum greifen.'; // cpg1.5
...
$lang_banning_php['email_field_invalid'] = 'Geben Sie eine gültige E-Mail-Adresse ein'; // cpg1.5
$lang_banning_php['ip_address_field_invalid'] = 'geben Sie eine gültige IP-Adresse an (x.x.x.x)'; // cpg1.5
$lang_banning_php['expiry_field_invalid'] = 'Geben Sie ein gültiges Ablaufdatum ein (JJJJ-MM-TT)'; // cpg1.5
...
$lang_bridgemgr_php['start_wizard'] = 'Den Bridge-Assistenten starten';
$lang_bridgemgr_php['finish'] = 'Fertigstellen';
$lang_bridgemgr_php['no_action_needed'] = 'Keine Aktion notwendig in diesem Schritt. Klicken Sie auf &quot;weiter&quot;, um fortzufahren.';
$lang_bridgemgr_php['reset_to_default'] = 'Auf Standard-Wert zurücksetzen';
$lang_bridgemgr_php['choose_bbs_app'] = 'Wählen Sie eine Anwendung, mit der Sie &quot;bridgen&quot; wollen';
$lang_bridgemgr_php['support_url'] = 'Für Support zu dieser Anwendung klicke hier';
$lang_bridgemgr_php['settings_path'] = 'Pfad(e) Ihrer Bridging-Anwendung';
...
$lang_bridgemgr_php['relative_path_to_config_file'] = 'Relativer Pfad zur Konfigurations-Datei Ihrer Bridging-Applikation';
...
$lang_bridgemgr_php['error_title'] = 'Sie müssen die aufgetretenen Fehler erst korrigieren. Gehen Sie zum vorherigen Schritt.';
$lang_bridgemgr_php['error_specify_bbs'] = 'Sie müssen angeben, welche Anwendung Sie mit Coppermine &quot;bridgen&quot; wollen.';
$lang_bridgemgr_php['finalize'] = 'Forums-Integration aktivieren/deaktivieren';
$lang_bridgemgr_php['finalize_explanation'] = 'Bisher wurden Ihre Einstellungen in die Datenbank geschrieben, aber das Bridging wurde noch nicht aktiviert. Sie können die Integration jederzeit später an- oder abschalten. Merken Sie sich auf jeden Fall den Benutzernamen und das Passwort Ihres Admin-Kontos (Coppermine ohne Bridging), da Sie es später evtl. brauchen, um die Einstellungen zu ändern. Wenn etwas schief läuft, gehen Sie zu %s und deaktivieren Sie das Bridging dort (verwenden Sie dazu Ihr Coppermine-Admin-Konto, das Sie beim Installieren von Coppermine benutzt haben).';
$lang_bridgemgr_php['your_bridge_settings'] = 'Ihre Bridge-Einstellungen';
...
$lang_bridgemgr_php['error_folder_not_exist'] = '%s existiert nicht. Korrigieren Sie den Wert, den Sie für %s eingegeben haben';
$lang_bridgemgr_php['error_cookie_not_readible'] = 'Coppermine kann den Cookie namens %s nicht lesen. Korrigieren Sie den Wert, den Sie für %s eingegeben haben, oder gehen Sie zum Administrationsbereich Ihres Forums und stellen Sie dort sicher, dass der Cookie für Coppermine lesbar ist.';
$lang_bridgemgr_php['error_mandatory_field_empty'] = 'Das Feld %s darf nicht leer bleiben - geben Sie den entsprechenden Wert ein.';
...
$lang_bridgemgr_php['recovery_explanation'] = 'Sie müssen sich erst anmelden, falls Sie hierher gekommen sind, um die Forums-Integration Ihrer Coppermine-Galerie zu administrieren. Falls Sie sich nicht anmelden können, weil die Integration nicht wie erwartet funktioniert, dann können Sie mit Hilfe dieser Seite die Integration (Bridging) deaktivieren. Die Eingabe von Benutzername und Passwort hier auf der Seite wird Sie nicht anmelden, sondern die Integration deaktivieren. Details dazu gibt es in der Dokumentation.';
...
$lang_bridgemgr_php['recovery_success_content'] = 'Sie haben die Forums-Integration erfolgreich deaktiviert. Ihre Coppermine-Galerie läuft jetzt im &quot;Standalone-Modus&quot; (ohne Integration/Bridging).';
$lang_bridgemgr_php['recovery_success_advice_login'] = 'Melden Sie sich als Admin an, um Ihre Bridge-Einstellungen zu bearbeiten und/oder die Forums-Integration wieder zu aktivieren.';
$lang_bridgemgr_php['goto_login'] = 'Zur Anmeldung gehen';
$lang_bridgemgr_php['goto_bridgemgr'] = 'zum Bridge-Assistenten gehen';
$lang_bridgemgr_php['recovery_failure_title'] = 'Authorisierung fehlgeschlagen';
$lang_bridgemgr_php['recovery_failure_content'] = 'Sie haben fehlerhafte Zugangsdaten eingegeben. Sie müssen die Zugangdaten des Admin-Kontos der &quot;Standalone-Version&quot; benutzen (normalerweise das Admin-Konto, das Sie bei der Installation von Coppermine angelegt haben).';
$lang_bridgemgr_php['try_again'] = 'versuchen Sie es nochmal';
$lang_bridgemgr_php['recovery_wait_title'] = 'Wartezeit noch nicht um';
$lang_bridgemgr_php['recovery_wait_content'] = 'Aus Sicherheitsgründen erlaubt das Skript keine fehlgeschlagenen Anmeldeversuche in kurzer Reihenfolge - deshalb müssen Sie ein bisschen warten, bevor Sie wieder einen Anmelde-Versuch unternehmen dürfen.';
$lang_bridgemgr_php['wait'] = 'warten Sie';
...
$lang_catmgr_php['confirm_delete'] = 'Wollen Sie diese Kategorie wirklich LÖSCHEN'; // js-alert
...
$lang_catmgr_php['group_create_alb'] = 'Der Gruppe erlauben, Alben zu erzeugen'; // cpg1.5
}
...
$lang_contact_php['your_name'] = 'Ihr Name'; // cpg1.5
$lang_contact_php['your_email'] = 'Ihre E-Mail-Adresse'; // cpg1.5
$lang_contact_php['subject'] = 'Betreff'; // cpg1.5
$lang_contact_php['your_message'] = 'Ihre Nachricht'; // cpg1.5
$lang_contact_php['name_field_mandatory'] = 'Bitte geben Sie Ihren Namen ein'; // cpg1.5 //js-alert
$lang_contact_php['name_field_invalid'] = 'Bitte geben Sie Ihren tatsächlichen Namen ein'; // cpg1.5 //js-alert
$lang_contact_php['email_field_mandatory'] = 'Bitte geben Sie E-Mail-Adresse ein'; // cpg1.5 //js-alert
$lang_contact_php['email_field_invalid'] = 'Bitte geben Sie eine gültige E-Mail-Adresse ein'; // cpg1.5 //js-alert
$lang_contact_php['subject_field_mandatory'] = 'Bitte geben Sie einen sinnvollen Betreff ein'; // cpg1.5 //js-alert
$lang_contact_php['message_field_mandatory'] = 'Bitte geben Sie Ihre Nachricht ein'; // cpg1.5 //js-alert
$lang_contact_php['confirmation'] = 'Bestätigung'; // cpg1.5
$lang_contact_php['email_headline'] = 'Am %s wurde diese E-Mail von dem Kontakformular auf %s versendet. Die IP-Adresse %s wurde verwendet.'; // cpg1.5
...
$lang_contact_php['user_info'] = 'Der %s namens %s mit der E-Mail-Adresse %s sagte:'; // cpg1.5
$lang_contact_php['failed_sending_email'] = 'Konnte die E-Mail nicht versenden. Bitte versuchen Sie es später noch einmal.'; //cpg1.5
$lang_contact_php['email_sent'] = 'Ihre E-Mail wurde gesendet.'; //cpg1.5
}
...
$lang_admin_php['email_settings'] = 'E-Mail-Einstellungen  (normalerweise muss hier nichts eingestellt werden; lassen Sie im Zweifelsfall alle Felder leer)'; // cpg1.5
...
$lang_admin_php['restore_cfg_confirm'] = 'Wollen Sie wirklich die gesamte Konfiguration auf Werkseinstellungen zurücksetzen? Dieser Schritt kann nicht rückgängig gemacht werden!'; // cpg1.5 //js-alert
...
$lang_admin_php['click_expand'] = 'Klicken Sie auf die jeweilige Bezeichnung zum Ausklappen des Abschnitts';
...
$lang_admin_php['gallery_admin_email'] = 'Galerie-Admin E-Mail'; // cpg1.5
$lang_admin_php['ecards_more_pic_target'] = 'URL Ihres Coppermine-Galerie Verzeichnisses'; // cpg1.5
...
$lang_admin_php['home_target'] = 'URL Ihrer Homepage'; // cpg1.5
...
$lang_admin_php['keyword_convert'] = 'Schlüsselwort-Trenner konvertieren'; // cpg1.5
...
$lang_admin_php['highlight_multiple'] = 'Um mehrere Einträge zu selektieren, halten Sie die [Strg]-Taste gedrückt'; // cpg1.5
...
$lang_admin_php['email_comment_notification'] = 'Admin über abgegebene Kommentare per E-Mail benachrichtigen'; // cpg1.5
...
$lang_admin_php['silly_safe_mode'] = 'Aktivierung von &quot;silly safe mode&quot; (Umgehung von falsch implemetierten Safe-Mode Einstellungen des Webhosts)'; // cpg1.5
...
$lang_admin_php['reg_requires_valid_email'] = 'Registrierung von Benutzern erfordert Überprüfung per E-Mail'; // cpg1.5
$lang_admin_php['reg_notify_admin_email'] = 'Admin über neu-registrierten Benutzer per E-Mail benachrichtigen'; // cpg1.5
...
$lang_admin_php['allow_duplicate_emails_addr'] = 'Zulassen, dass mehrere Benutzer die gleiche E-Mail-Adresse haben'; // cpg1.5
$lang_admin_php['upl_notify_admin_email'] = 'Admin über genehmigungspflichtige Benutzer-Uploads per E-Mail benachrichtigen'; // cpg1.5
$lang_admin_php['allow_memberlist'] = 'Angemeldeten Benutzern Benutzerliste anzeigen'; // cpg1.5
$lang_admin_php['allow_email_change'] = 'Benutzern erlauben, Ihre E-Mail-Adresse im Profil zu ändern'; // cpg1.5
...
$lang_admin_php['allow_user_move_album'] = 'Benutzern erlauben, Ihre Alben von/nach erlaubten Kategorien zu verschieben'; // cpg1.5
$lang_admin_php['allow_user_album_keyword'] = 'Benutzern erlauben, Alben-Schlüsselwörter zu vergeben'; // cpg1.5
$lang_admin_php['allow_user_edit_after_cat_close'] = 'Benutzern erlauben, Ihre Alben zu bearbeiten, wenn sie sich in gesperrten Kategorienbefinden'; // cpg1.5
$lang_admin_php['login_method_username'] = 'Benutzername'; // cpg1.5
$lang_admin_php['login_method_email'] = 'E-Mail-Adresse'; // cpg1.5
$lang_admin_php['login_method_both'] = 'Beides (Benutzername oder E-Mail-Adresse)'; // cpg1.5
...
$lang_admin_php['config_setting_invalid'] = 'Der Wert, den Sie für &laquo;%s&raquo; eingegeben haben ist ungültig, bitte überprüfen.'; // cpg1.5
$lang_admin_php['config_setting_ok'] = 'Ihre Änderung für &laquo;%s&raquo; wurde gespeichert.'; // cpg1.5
...
$lang_admin_php['contact_form_guest_email_field'] = 'Feld &quot;Absender-E-Mail&quot; für Gäste anzeigen'; // cpg1.5
$lang_admin_php['contact_form_subject_field'] = '&quot;Betreff&quot;-Feld anzeigen'; // cpg1.5
$lang_admin_php['contact_form_subject_content'] = 'Betreff für E-Mails, die vom Kontaktformular erzeugt werden'; // cpg1.5
$lang_admin_php['contact_form_sender_email'] = 'E-Mail-Adresse des Benutzers als &quot;von&quot;-Adresse der E-Mail verwenden'; // cpg1.5
...
$lang_admin_php['do_not_change'] = 'Ändere diese Einstellung auf keinen Fall, wenn Sie nicht ganz genau wissen, was Sie tun!'; // cpg1.5
...
$lang_admin_php['warning_dont_submit'] = 'Wenn Sie sich nicht über die Auswirkung dieser Einstellungen im Klaren sind, senden Sie dieses Formular nicht ab und lesen Sie stattdessen zuerst die Doku.'; // cpg1.5 // js-alert
...
$lang_db_ecard_php['ecard_by_sender_email'] = 'nach E-Mail-Adresse des Absenders';
...
$lang_db_ecard_php['ecard_by_recipient_email'] = 'nach E-Mail-Adresse des Empfängers';
$lang_db_ecard_php['ecard_number'] = 'Eintrag %s bis %s von %s anzeigen';
...
$lang_db_ecard_php['invalid_data'] = 'Die Daten für die gewünschte eCard wurden von Ihrem E-Mail-Client korrumpiert. Überprüfen Sie den Link auf Vollständigkeit.';
}
...
$lang_db_input_php['empty_name_or_com'] = 'Sie müssen Ihren Namen und einen Kommentar eingeben';
$lang_db_input_php['com_added'] = 'Ihr Kommentar wurde hinzugefügt'; // cpg1.5
$lang_db_input_php['alb_need_title'] = 'Sie müssen einen Titel für das Album eingeben!';
$lang_db_input_php['no_udp_needed'] = 'Keine Aktualisierung notwendig.';
$lang_db_input_php['alb_updated'] = 'Das Album wurde aktualisiert';
$lang_db_input_php['unknown_album'] = 'Das gewählte Album existiert nicht oder Sie haben keine Berechtigung, Dateien in dieses Album hochzuladen';
$lang_db_input_php['no_pic_uploaded'] = 'Es wurde keine Datei hochgeladen!<br />Wenn Sie tatsächlich eine Datei zum Hochladen selektiert haben, überprüfen Sie, ob Ihr Server das Hochladen von Dateien zulässt...';
...
$lang_db_input_php['err_fsize_too_large'] = 'Die Datei, die Sie hochgeladen haben, ist zu groß (maximal zulässig ist %s x %s) !';
$lang_db_input_php['err_imgsize_too_large'] = 'Die Datei, die Sie hochgeladen haben, ist zu groß (maximal zulässig ist %s kB) !';
$lang_db_input_php['err_invalid_img'] = 'Die Datei, die Sie hochgeladen haben, ist kein gültiger Bildtyp!';
$lang_db_input_php['allowed_img_types'] = 'Sie können nur %s Bilder hochladen.';
$lang_db_input_php['err_insert_pic'] = 'Das Bild \'%s\' kann nicht in das Album eingefügt werden ';
$lang_db_input_php['upload_success'] = 'Ihre Datei wurde erfolgreich hochgeladen.<br />Sie wird nach der Bestätigung durch den Admin sichtbar sein.';
$lang_db_input_php['notify_admin_email_subject'] = '%s - Upload-Benachrichtigung';
$lang_db_input_php['notify_admin_email_body'] = '%s hat eine Datei hochgeladen, die bestätigt werden muss. Gehen Sie zu %s';
$lang_db_input_php['info'] = 'Information';
$lang_db_input_php['com_added'] = 'Ihr Kommentar wurde hinzugefügt';
$lang_db_input_php['com_updated'] = 'Ihr Kommentar wurde aktualisiert';  // cpg1.5
$lang_db_input_php['alb_updated'] = 'Album aktualisiert';
$lang_db_input_php['err_comment_empty'] = 'Ihr Kommentar enthält keine Zeichen!';
$lang_db_input_php['err_invalid_fext'] = 'Nur Dateien mit den folgenden Erweiterungen sind zulässig:'; // js-alert
$lang_db_input_php['no_flood'] = 'Leider Sind Sie schon der Autor des letzten Kommentars zu dieser Datei.<br />Bearbeiten Sie Ihren bestehenden Kommentar, wenn Sie ihn verändern wollen';
$lang_db_input_php['redirect_msg'] = 'Sie werden weitergeleitet.<br />Klicken Sie \'weiter\', falls sich die Seite nicht automatisch aktualisiert';
$lang_db_input_php['upl_success'] = 'Ihre Datei wurde erfolgreich hinzugefügt';
$lang_db_input_php['email_comment_subject'] = 'In der Coppermine Photo Gallery wurde ein Kommentar abgegeben';
$lang_db_input_php['email_comment_body'] = 'Jemand hat einen Kommentar in Ihrer Galerie abgegeben. Um den Kommentar anzusehen, klicken Sie hier:';
$lang_db_input_php['album_not_selected'] = 'Kein Album ausgewählt';
$lang_db_input_php['com_author_error'] = 'Ein registrierter Benutzer verwendet diesen Namen bereits, melden Sie sich an oder verwenden Sie einen anderen Namen.';
}
...
$lang_display_comments['confirm_delete'] = 'Wollen Sie diesen Kommentar wirklich löschen?'; // js-alert
$lang_display_comments['add_your_comment'] = 'Fügen Sie Ihren Kommentar hinzu';
$lang_display_comments['name'] = 'Name';
$lang_display_comments['comment'] = 'Kommentar';
$lang_display_comments['your_name'] = 'Ihr Name';
...
$lang_display_comments['log_in_to_comment'] = 'Anonyme Kommentare sind hier nicht erlaubt. %sMelden Sie sich an%s, um einen Kommentar abzugeben'; // cpg1.5 // do not translate the %s placeholders - they will be used as wrappers for the link (<a>)
$lang_display_comments['default_username_message'] = 'Bitte geben Sie Ihren Namen an, um einen Kommentar abzugeben'; // cpg1.5
$lang_display_comments['comment_rejected'] = 'Ihr Kommentar wurde abgelehnt'; // cpg1.5
...
$lang_ecard_php['invalid_email'] = 'Achtung: ungültige E-Mail-Adresse !';
$lang_ecard_php['ecard_title'] = 'Eine eCard von %s für Sie';
...
$lang_ecard_php['view_ecard'] = 'Falls diese eCard nicht korrekt angezeigt wird, klicken Sie auf den folgenden Link: ';
$lang_ecard_php['view_ecard_plaintext'] = 'Markieren Sie die folgende URL und fügen Sie sie in die Adresszeile Ihres Browsers ein, um diese eCard anzuzeigen:';
$lang_ecard_php['view_more_pics'] = 'Klicken Sie auf diesen Link, um mehr Bilder ansehen zu können!';
$lang_ecard_php['send_success'] = 'Ihre eCard wurde gesendet';
$lang_ecard_php['send_failed'] = 'Leider kann der Server Ihre eCard nicht versenden...';
$lang_ecard_php['from'] = 'Von';
$lang_ecard_php['your_name'] = 'Ihr Name';
$lang_ecard_php['your_email'] = 'Ihre E-Mail-Adresse';
$lang_ecard_php['to'] = 'An';
$lang_ecard_php['rcpt_name'] = 'Empfänger Name';
$lang_ecard_php['rcpt_email'] = 'Empfänger E-Mail-Adresse';
...
$lang_report_php['invalid_email'] = 'Achtung: ungültige E-Mail-Adresse!';
...
$lang_report_php['send_success'] = 'Ihre Meldung wurde gesendet';
$lang_report_php['send_failed'] = 'Der Server kann leider Ihre Meldung nicht versenden...';
$lang_report_php['from'] = 'Von';
$lang_report_php['your_name'] = 'Ihr Name';
$lang_report_php['your_email'] = 'Ihre E-Mail-Adresse';
...
$lang_report_php['invalid_data'] = 'Die Daten des Reports, auf den Sie zugreifen wollen sind durch Ihr E-Mail-Programm zerstört worden. Überprüfen Sie, ob der Link vollständig ist.';
}
...
$lang_editpics_php['error_editor_class'] = 'Editor-Klasse für Ihre Grössenänderungs-Methode ist nicht implementiert'; // cpg 1.5
$lang_editpics_php['error_document_size'] = 'Dokument hat keine Breite oder Höhe'; //cpg 1.5  //js-alert
$lang_editpics_php['success_picture'] = 'Bild wurde erfolgreich gespeichert - Sie können dieses Fenster jetzt %sschliessen%s'; //cpg 1.5 // do not translate "%s" here
$lang_editpics_php['success_thumb'] = 'Thumbnail wurde erfolgreich gespeichert - Sie können dieses Fenster jetzt %sschliessen%s'; //cpg 1.5 // do not translate "%s" here
...
$lang_forgot_passwd_php['err_already_logged_in'] = 'Sie sind schon angemeldet!';
$lang_forgot_passwd_php['enter_email'] = 'Geben Sie Ihre E-Mail-Adresse ein';
...
$lang_forgot_passwd_php['failed_sending_email'] = 'Die E-Mail mit der Passwort-Erinnerung kann nicht gesendet werden!';
$lang_forgot_passwd_php['email_sent'] = 'Eine E-Mail mit Ihrem Benutzernamen und einem neuen Passwort wurde an %s gesendet.';
$lang_forgot_passwd_php['verify_email_sent'] = 'Eine E-Mail wurde an %s gesendet. Bitte überprüfen Sie Ihre Mailbox, um den Vorgang abzuschliessen.';
...
$lang_forgot_passwd_php['passwd_reset_subject'] = '%s - Ihr neues Passwort';

$lang_forgot_passwd_php['account_verify_email'] = <<< EOT
Sie haben ein neues Passwort beantragt - um dieses neue Passwort tatsächlich zu erhalten, klicke auf nachstehenden Link:
...
Hier ist das neue Passwort, dass Sie beantragt haben:

Benutzername:{USER_NAME}
Passwort:{PASSWORD}

Klicken Sie <a href="{SITE_LINK}">{SITE_LINK}</a>, um sich anzumelden.
...
$lang_groupmgr_php['confirm_del'] = 'Achtung: wenn Sie eine Gruppe löschen werden die dazu gehörenden Benutzer in die Gruppe \'Registrierte Benutzer\' verschoben!\n\nWollen Sie das ?'; // js-alert
...
$lang_album_admin_menu['confirm_delete'] = 'Wollen Sie dieses Album wirklich LÖSCHEN? \\nAlle darin befindlichen Dateien und Kommentare werden ebenfalls gelöscht.';
...
$lang_install['email'] = 'E-Mail address';
$lang_install['email_no_match'] = 'E-Mail addresses do not match or are invalid.';
$lang_install['email_verif'] = 'Verify E-Mail';
...
$lang_keywordmgr_php['confirm_delete'] = 'Wollen Sie wirklich das Stichwort %s aus der gesamten Galerie löschen?'; // js-alert
...
$lang_login_php['both'] = 'Benutzername / E-Mail-Adresse'; // cpg1.5
...
$lang_picmgr_php['explanation_header'] = 'Die benutzerdefinierte Sortierreihenfolge, die Sie auf dieser Seite wählen können wird nur angewendet, wenn';
...
$lang_picmgr_php['change_album'] = 'Wenn Sie das Album ändern werden Ihre vorherigen Änderungen nicht in Betracht gezogen!'; // cpg1.5 // js-alert
$lang_picmgr_php['submit_reminder'] = 'Die Änderungen der Sortierreihenfolge werden nicht gespeichert, bis Sie auf &quot;Anwenden&quot; klicken.'; // cpg1.5
}
...
$lang_pluginmgr_php['confirm_remove'] = 'Anmerkung: Die Plugin-API ist deaktiviert.  Möchtest Sie das gewählte Plugin manuell löschen und eventuelle Säuberungs-Skripte ignorieren'; // cpg1.5
...
$lang_pluginmgr_php['confirm_version'] = 'Versions-Mindestanforderungen für dieses Plugin konnte nicht festgestellt werden. Dies ist normalerweise ein Anzeichen dafür, dass das Plugin nicht für Ihre Version von Coppermine erstellt wurde und daher möglicherweise Ihre Galerie zum Absturz bringt. Trotzdem mit der Installation fortfahren (nicht empfohlen)?'; // cpg1.5 // js-alert
}
...
$lang_rate_pic_php['already_rated'] = 'Sie haben diese Datei schon bewertet';
$lang_rate_pic_php['rate_ok'] = 'Ihre Bewertung wurde akzeptiert';
$lang_rate_pic_php['forbidden'] = 'Sie können Ihre eigenen Dateien nicht bewerten.';
}
...
<br />
Diese Seite benutzt Cookies, um Daten auf Ihrem Rechner zu speichern. Diese Cookies dienen nur dazu, die Bedienung der Seite zu ermöglichen. Die E-Mail-Adresse wird nur dazu verwendet, die Registrierungs-Details und das Passwort zu bestätigen.<br />
<br />
...
$lang_register_php['err_duplicate_email'] = 'Es hat sich schon ein anderer Benutzer mit der angegebenen E-Mail-Adresse registriert';
...
$lang_register_php['email'] = 'E-Mail-Adresse';
...
$lang_register_php['failed_sending_email'] = 'Die Registrierungs-Bestätigung kann nicht per E-Mail versendet werden!';
$lang_register_php['thank_you'] = 'Danke für Ihre Registrierung.<br />Eine E-Mail mit Informationen, wie Sie Ihr Benutzerkonto aktivieren können, wurde an die angegebene E-Mail-Adresse gesendet.';
...
$lang_register_php['thank_you_admin_activation'] = 'Danke.<br />Ihre Registrierung wurde an den Administrator weitergeleitet zur Aktivierung. Nach erfolgter Aktiverung werden Sie eine E-Mail erhalten.';
$lang_register_php['acct_active_admin_activation'] = 'Das Benutzerkonto ist jetzt aktiv. Dem Benutzer wurde eine Benachrichtigung darüber per E-Mail gesendet.';
...
$lang_register_php['email_warning1'] = 'Das E-Mail-Adressfeld darf nicht leer sein!'; // cpg1.5
$lang_register_php['email_warning2'] = 'Die eingegebene E-Mail-Adresse ist ungültig!'; // cpg1.5
...
$lang_sidebar_php['ie_mac_explain'] = 'Wenn Sie den Internet Explorer 5 oder höher auf MacOS benutzen, %söffnen Sie die Sidebar-Seite%s in einem neuen Fenster. Öffnen Sie in diesem neuen Fenster den "Page Holder"-Reiter auf der linken Seite des Fensters. Klicken Sie "Hinzufügen". Wenn Sie Ihre Einstellungen für zukünftige Sessions beibehalten wollen, klicken Sie auf "Favoriten" und wählen Sie "Zu Page Holder Favoriten hinzufügen".'; // cpg1.5
$lang_sidebar_php['ie_win'] = 'Internet Explorer 5 und besser auf Windows'; // cpg1.5
$lang_sidebar_php['ie_win_explain'] = 'Wenn Sie den Internet Explorer 5 oder höher unter Windows benutzen können Sie die Sidebar zu Ihrer Links-Werkzeugleiste hinzufügen oder zu Ihren Favoriten, indem Sie %shier%s rechts-klicken und "Zu Favoriten hinzufügen" aus dem Kontext-Menü wählen. Dieser Link installiert unsere Sidebar nicht als Standard für Ihre Suche, so dass Ihr System nicht verändert wird.'; // cpg1.5
$lang_sidebar_php['ie7_win'] = 'Internet Explorer 7 auf Windows XP/Vista'; // cpg1.5
$lang_sidebar_php['ie7_win_explain'] = 'Wenn Sie den Internet Explorer 7 oder höher unter Windows benutzen können Sie ein Navigations-Popup zu Ihrer Links-Werkzeugleiste hinzufügen oder zu Ihren Favoriten, indem Sie %shier%s rechts-klicken und "Zu Favoriten hinzufügen" aus dem Kontext-Menü wählst. In früheren Versionen des IE war es möglich, die tatsächliche Sidebar zu installieren, aber im IE7 ist das nicht möglich, ohne komplizierte Hacks der Registry zu benutzen. Es wird empfohlen, einen anderen Browser zu benutzen, wenn Sie die tatsächliche Sidebar benutzen wollen.'; // cpg1.5
$lang_sidebar_php['opera'] = 'Opera 6 und besser'; // cpg1.5
$lang_sidebar_php['opera_explain'] = 'Wenn Sie Opera benutzen können Sie %sauf diesen Link klicken%s, um die Sidebar Ihren anderen Sidebars hinzuzufügen. Aktiviere anschließend "Im Panel anzeigen". Die Sidebar kann deinstalliert werden durch rechts-klicken auf den Reiter und anschließend "Löschen" aus dem Kontextmenü wählen.'; // cpg1.5
$lang_sidebar_php['additional_options'] = 'Zusätzliche Optionen'; // cpg1.5
$lang_sidebar_php['additional_options_explain'] = 'Falls Sie einen anderen Browser als den oben angegebenen benutzen klicken Sie %shier%s, um alle Sidebar-Optionen anzuzeigen.'; // cpg1.5
$lang_sidebar_php['cannot_add_sidebar'] = 'Sidebar kann nicht hinzugefügt werden! Ihr Browser unterstützt diese Methode nicht.'; // cpg1.5 //JS-alert
...
$lang_search_new_php['select_dir_msg'] = 'Diese Funktion ermöglicht, mehrere Dateien der Galerie hinzuzufügen, die mit einem FTP-Programm schon auf Ihre Webseite hochgeladen wurden.<br />Wähle das Verzeichnis, in das Sie die Dateien hochgeladen haben.';
$lang_search_new_php['no_pic_to_add'] = 'Keine Datei zum Hinzufügen gefunden';
$lang_search_new_php['need_one_album'] = 'Sie brauchen mindestens ein Album, um dieses Funktion auszuführen';
$lang_search_new_php['warning'] = 'Achtung';
$lang_search_new_php['change_perm'] = 'Das Skript kann nicht in dieses Verzeichnis schreiben, Sie müssen die Lese-/Schreibberechtigung (chmod) auf 755 oder 777 setzen, bevor Sie versuchen, Dateien hinzuzufügen!';
...
$lang_search_new_php['no_folders'] = 'Im Verzeichnis "albums" wurden noch keine Unterverzeichnisse angelegt. Sie müssen mindestens ein benutzerdefiniertes Unterverzeichnis innerhalb des Ordners "albums" anlegen und Ihre Dateien per FTP dorthin hochladen. Sie dürfen per FTP keine Dateien in die Unterverzeichnisse "userpics" oder "edit" hochladen, da diese für http-uploads und interne Zwecke reserviert sind.';
...
$lang_send_activation_php['err_already_logged_in'] = 'Sie sind schon angemeldet!'; //cpg1.5
$lang_send_activation_php['activation_not_required'] = 'Diese Webseite erfordert keine Aktiverung per E-Mail'; //cpg1.5
...
$lang_send_activation_php['enter_email'] = 'Gib Ihre E-Mail-Adresse ein'; //cpg1.5
$lang_send_activation_php['submit'] = 'Los'; //cpg1.5
$lang_send_activation_php['failed_sending_email'] = 'Konnte E-Mail mit Aktivierungs-Link nicht versenden'; //cpg1.5
$lang_send_activation_php['activation_email_sent'] = 'Eine E-Mail mit Aktivierungs-Link wurde an %s gesendet. Bitte überprüfe Deinen Posteingang, um den Registrierungsprozess abzuschliessen'; //cpg1.5
}
...
$lang_stat_details_php['reset_votes_individual_confirm'] = 'Sind Sie sicher, dass die selektierten Bewertungen gelöscht werden sollen? Dieser Vorgang kann nicht rückgängig gemacht werden!'; //cpg1.5
...
$lang_upload_php['up_instr_2'] = 'Benutzen Sie dann die "Browse"-Schaltfläche, um zu der Datei auf Ihrem Rechner zu navigieren, die Sie hochladen wollen.';
$lang_upload_php['up_instr_3'] = 'Wählen Sie mehrere Dateien zum Hochladen aus, indem Sie Schritt 3 wiederholen';
...
$lang_upload_php['err_no_alb_uploadables'] = 'Leider gibt es kein Album, in das Sie Bilder hochladen dürfen';
...
$lang_upload_php['allowed_types'] = 'Sie dürfen Dateien mit den folgenden Endungen hochladen:'; //cpg1.5
...
$lang_upload_php['xp_publish_promote'] = 'Wenn Sie Windows XP/Vista benutzen können Sie auch den Windows XP Uploading Wizard benutzen um Dateien hochzuladen, der eine einfachere Benutzerschnittstelle bietet.'; // cpg1.5
...
$lang_upload_swf_php['queue_limit'] = 'Sie haben zu viele Dateien in die Warteschlange gestellt.'; //cpg1.5
$lang_upload_swf_php['upload_limit_1'] = 'Sie haben die Begrenzung zum Hochladen erreicht.'; //cpg1.5
$lang_upload_swf_php['upload_limit_2'] = 'Sie können bis zu %s Datei(en) auswählen'; //cpg1.5
}
...
$lang_usermgr_php['lv_a'] = 'Letzter Seitenbesuch aufsteigendg';
...
$lang_usermgr_php['err_edit_self'] = 'Sie können Dein eigenes Profil hier nicht bearbeiten, benutze dafür den Link \'mein Profil\'';
...
$lang_usermgr_php['confirm_del'] = 'Wollen Sie diesen Benutzer wirklich LÖSCHEN? \\nAlle seine Dateien und Alben werden ebenfalls gelöscht.'; // js-alert
...
$lang_usermgr_php['note_list'] = 'Wenn Sie das derzeitige Passwort nicht ändern wollen, lassen Sie das Feld "Passwort" leer';
...
$lang_usermgr_php['user_email'] = 'E-Mail-Adresse des Benutzers';
...
$lang_usermgr_php['alert_no_selection'] = 'Sie müssen zuerst mindestens einen Benutzer auswählen!'; // js-alert
...
$lang_usermgr_php['send_login_data'] = 'Anmeldungsdaten an diesen Benutzer versenden (Passwort wird per E-Mail gesendet)'; //cpg1.5
$lang_usermgr_php['send_login_email_subject'] = 'Ihre neuen Zugangsdaten'; //cpg1.5
$lang_usermgr_php['failed_sending_email'] = 'Die E-Mail mit den Zugangsdaten konnte nicht versendet werden!'; //cpg1.5
...
$lang_update_php['start_page'] = 'Falls nicht (oder wenn Sie die Überprüfung überspringen wollen) können Sie %szur Startseite Deiner Galerie gehen%s'; // cpg1.5 // Leave the %s untouched when translating - it wraps the link
...
$lang_util_php['refresh_db_explanation'] = 'Diese Option liest die Dateigrößen und -abmessungen erneut ein. Benutzen Sie sie, wenn die Speicherplatz-Anzeige unkorrekt erscheint oder wenn Sie die Dateien manuell verändert haben.';
...
$lang_util_php['delete_old_explanation'] = 'Löscht alle Dateien (Bilder in voller Grösse, Bilder in Zwischengröße, Thumbnails), die älter sind als die Anzahl von Tagen, die Sie angeben. Benutzen Sie dieses Feature, um Plattenplatz auf dem Server frei zu bekommen.';  // cpg1.5
...
$lang_plugin_php['onlinestats_config_install'] = 'Dieses Plugin verursacht zusätzliche Datenbankabfragen bei jedem Lauf und verbraucht daher zusätzliche Resourcen auf dem Server. Wenn Ihre Galerie bereits langsam läuft und Sie eine große Menge von Benutzern haben sollten Sie dieses Plugin nicht installiert.';
$lang_plugin_php['onlinestats_we_have_reg_member'] = 'Es gibt %s registrierten Benutzer';
$lang_plugin_php['onlinestats_we_have_reg_members'] = 'Es gibt %s registrierte Benutzer';
$lang_plugin_php['onlinestats_most_recent'] = 'Der neueste registrierte Benutzer ist %s';
$lang_plugin_php['onlinestats_is'] = 'Insgesamt ist %s Besucher online';
$lang_plugin_php['onlinestats_are'] = 'Insgesamt sind %s Besucher online';
$lang_plugin_php['onlinestats_and'] = 'und';
$lang_plugin_php['onlinestats_reg_member'] = '%s registrierter Benutzer';
$lang_plugin_php['onlinestats_reg_members'] = '%s registrierte Benutzer';
$lang_plugin_php['onlinestats_guest'] = '%s Gast';
$lang_plugin_php['onlinestats_guests'] = '%s Gäste';
$lang_plugin_php['onlinestats_record'] = 'Am meisten jemals online: %s am %s';
$lang_plugin_php['onlinestats_since'] = 'Registrierte Benutzer, die in den letzten %s Minuten online waren: %s';
